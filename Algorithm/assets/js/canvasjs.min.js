(function() {
    ...
    function Ua(k, m, v) {
        "millisecond" === v ? k.setMilliseconds(k.getMilliseconds() + 1 * m) : "second" === v ? k.setSeconds(k.getSeconds() + 1 * m) : "minute" === v ? k.setMinutes(k.getMinutes() + 1 * m) : "hour" === v ? k.setHours(k.getHours() + 1 * m) : "day" === v ? k.setDate(k.getDate() + 1 * m) : "week" === v ? k.setDate(k.getDate() + 7 * m) : "month" === v ? k.setMonth(k.getMonth() + 1 * m) : "year" === v && k.setFullYear(k.getFullYear() + 1 * m);
        return k
    }
    function $(k, m) {
        var v = !1;
    ...
    function V(k, m, v, u, y) {
        ...
        u.push([k, m, v, y]);
        return k.addEventListener ? (k.addEventListener(m, v, y),
        v) : k.attachEvent ? (u = function(m) {
            m = m || window.event;
    ...
    function fb(k) {
        if (k._menuButton)
            k.exportEnabled ? Ja(k._menuButton) : ta(k._menuButton);
        ...
        if (!k._dropdownMenu && k.exportEnabled && u) {
            ...
            V(v, "mouseout", function() {
                m || (this.style.backgroundColor = k.toolbar.backgroundColor,
    ...
    function gb(k) {
        if (!hb) {
            ...
            k.creditText = Y("B`ow`rKR/bnl")) : (m = k.updateOption("creditText"),
    ...
    function ua(k, m, v) {
        m.getAttribute("state") || (m.style.backgroundColor = k.toolbar.backgroundColor,
        ...
        m.getAttribute("state") !== v && (m.setAttribute("state", v),
        ...
        m.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + ib[v].image + "' alt='" + k._cultureInfo[v + "Text"] + "' />")
    }
    function Ja() {
    ...
    function Qa(k, m, v, s, u) {
        ...
        "undefined" !== typeof u && (k = Math.max(u, k)));
    ...
    function W(k, m, v, u, y) {
        ...
        k = {};
        this.theme && s(this.parent) && s(m) && s(u) ? k = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[m]) && (null === u ? k = this.parent.themeOptions[m] : 0 < this.parent.themeOptions[m].length && (u = Math.min(this.parent.themeOptions[m].length - 1, u),
    ...
    var Fa = !1, J = {}, u = !!document.createElement("canvas").getContext, pa = {
        Chart: {
            width: 500,
            height: 400,
            zoomEnabled: !1,
        ...
        en: {}
    }, y = u ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Da = u ? "Impact, Charcoal, sans-serif" : "Arial", ya = {
    ...
    (function() {
        J.fSDec = function(k) {
            for (var m = "", v = 0; v < k.length; v++)
                m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(v));
            return m
        }
        ;
        J.obj = {
    ...
    var eb = function() {
        ...
        try {
            ...
            window.addEventListener && (window.addEventListener("test", null, m),
      ...
      , ea = function(k, m, v) {
        ...
        for (var L = 0; E && L < E.length; L++)
            ...
            "." === m && 0 > N)
                ...
                if ("%" === m)
                    ...
                    "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || (Q = !0);
                0 > N ? (M.push(m),
                "#" === m || "0" === m ? P++ : "," === m && V++) : (I.push(m),
                "#" !== m && "0" !== m || J++)
            }
        Q && (m = Math.floor(k),
        ...
        for (Q = E = L = J = N = 0; 0 < M.length; )
            ...
            "#" === m || "0" === m)
                ...
                "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (L++,
                E = Q,
                Q = 0,
                0 < D.length && (v = y + v)) : v = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + v : m + v : (m = 0 > W ? m.replace("+", "").replace("-", "") : m.replace("-", ""),
        ...
        for (M = !1; 0 < I.length; )
            m = I.shift(),
            "#" === m || "0" === m ? 0 < k.length && 0 !== Number(k.join("")) ? (y += k.shift(),
            M = !0) : "0" === m && (y += "0",
            M = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? y += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? y += m : (m = 0 > W ? m.replace("+", "").replace("-", "") : m.replace("-", ""),
      ...
      , Ma = function(k) {
        var m = 0
          , v = 0;
        k = k || window.event;
        k.offsetX || 0 === k.offsetX ? (m = k.offsetX,
        v = k.offsetY) : k.layerX || 0 == k.layerX ? (m = k.layerX,
        v = k.layerY) : (m = k.pageX - k.target.offsetLeft,
      ...
      , ab = window && window[Y("mnb`uhno")] && window[Y("mnb`uhno")].href && window[Y("mnb`uhno")].href.indexOf && (-1 !== window[Y("mnb`uhno")].href.indexOf(Y("b`ow`rkr/bnl")) || -1 !== window[Y("mnb`uhno")].href.indexOf(Y("gdonqhy/bnl")) || -1 !== window[Y("mnb`uhno")].href.indexOf(Y("gheemd")))
    ...
    W.prototype.setOptions = function(k, m) {
        if (pa[this._defaultsKey]) {
            var v = pa[this._defaultsKey], s;
            for (s in v)
                "publicProperties" !== s && v.hasOwnProperty(s) && (this[s] = k && s in k ? k[s] : m && s in m ? m[s] : v[s])
        } else
    ...
    W.prototype.get = function(k) {
        ...
        if (m.hasOwnProperty(k) || m.publicProperties && m.publicProperties.hasOwnProperty(k))
            return this[k];
    ...
    W.prototype.addTo = function(k, m, s, u) {
        ...
        y.hasOwnProperty(k) || y.publicProperties && y.publicProperties.hasOwnProperty(k) && "readWrite" === y.publicProperties[k] ? (this.options._isPlaceholder && this.createUserOptions(),
        "undefined" === typeof this.options[k] && (this.options[k] = []),
        k = this.options[k],
        s = "undefined" === typeof s || null === s ? k.length : s,
        k.splice(s, 0, m),
        u && (this.stockChart || this.chart || this).render()) : window.console && (y.publicProperties && y.publicProperties.hasOwnProperty(k) && "readOnly" === y.publicProperties[k] ? window.console.log('Property "' + k + '" is read-only.') : window.console.log('Property "' + k + "\" doesn't exist. Please check for typo."))
    }
    ;
        ...
        if ("undefined" !== typeof k || this.options._isPlaceholder)
            ...
            this.isOptionsInArray) {
                ...
                var m = this.parent.options[this.optionsName]
                  , s = m.length;
                this.options._isPlaceholder || (Ba(m),
                s = m.indexOf(this.options));
                this.options = "undefined" === typeof k ? {} : k;
                m[s] = this.options
            } else
                this.options = "undefined" === typeof k ? {} : k,
                k = this.parent.options,
                this.optionsName ? m = this.optionsName : (m = this._defaultsKey) && 0 !== m.length ? (s = m.charAt(0).toLowerCase(),
    ...
    W.prototype.updateOption = function(k) {
        ...
        var m = pa[this._defaultsKey]
          ...
          , J = this._index;
        this.theme && s(this.parent) && s(E) && s(J) ? u = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[E]) && (null === J ? u = this.parent.themeOptions[E] : 0 < this.parent.themeOptions[E].length && (u = Math.min(this.parent.themeOptions[E].length - 1, J),
    ...
    W.prototype.addEventListener = function(k, m, s) {
        k && m && (this._eventListeners[k] = this._eventListeners[k] || [],
        ...
        if (0 !== this.fontSize) {
            ...
            for (s = 0; s < this._wrappedText.lines.length; s++) {
                ...
                if ("right" === this.horizontalAlign || "right" === this.textAlign)
                    ...
                    u = (this.width - (this.leftPadding + this.rightPadding)) / 2 - E.width / 2 + this.leftPadding;
    ...
    ia.prototype._getLineWithWidth = function(k, m, s) {
        ...
        s > m && 1 < D.length && (D = D.substr(0, D.length - 1),
        s = this.ctx.measureText(D).width);
        m = !0;
    ...
    xa.prototype.setLayout = function() {
        if (this.text) {
            var k = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, m = k.layoutManager.getFreeSpace(), u = m.x1, y = m.y1, E = 0, J = 0, D = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, N, I;
            ...
            E = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = m.height - 4),
            J = 0.5 * m.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = m.width - 4),
            J = 0.5 * m.height - 4));
            var M;
            ...
            M = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (y = m.y1 + 2,
            I = "top") : "bottom" === this.verticalAlign && (y = m.y2 - 2 - M.height,
            I = "bottom"),
            ...
            this.width = M.width,
            this.height = M.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (u = m.x1 + 2,
            y = m.y2 - 2 - (this.maxWidth / 2 - M.width / 2),
            E = -90,
            I = "left",
            this.width = M.height,
            this.height = M.width) : "right" === this.horizontalAlign ? (u = m.x2 - 2,
            y = m.y1 + 2 + (this.maxWidth / 2 - M.width / 2),
            E = 90,
            I = "right",
            this.width = M.height,
            this.height = M.width) : "center" === this.horizontalAlign && (y = k.y1 + (k.height / 2 - M.height / 2),
    ...
    var Na = {
        ...
        formatNumber: function(k, m, s) {
            s = s || "en";
            if (Ia[s])
                return ea(k, m || "#,##0.##", new Ha(s));
            throw "Unknown Culture Name";
        },
        formatDate: function(k, m, s) {
            s = s || "en";
            if (Ia[s])
                return za(k, m || "DD MMM YYYY", new Ha(s));
            throw "Unknown Culture Name";
        }
    };
    ...
    y = Na.Chart = function() {
        ...
        function m(a, d, c) {
            ...
            u ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = sa(a, d),
        ...
        function v(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)
                if (0 == e)
                    ...
                    b = Math.abs((a[p].x - a[f].x) / (0 === a[p].x - a[l].x ? 0.01 : a[p].x - a[l].x)) * (d - 1) / 2 + 1;
                    var A = (a[p].x - a[f].x) / b;
                    b = (a[p].y - a[f].y) / b;
        ...
        function y(a, d, c, b, e, f, p, l, A, h) {
            ...
            a.beginPath();
            A && 0 < l.thickness ? (a.moveTo(b - p.thickness / 2, Math.round((c + e) / 2) - r),
            a.lineTo(d + p.thickness / 2, Math.round((c + e) / 2) - r)) : 0 < l.thickness && (a.moveTo(Math.round((d + b) / 2) - r, c + p.thickness / 2),
            ...
            a.beginPath();
            A && 0 < p.thickness ? (a.moveTo(b - n, c),
            a.lineTo(b - n, e),
            a.moveTo(d + n, c),
            a.lineTo(d + n, e)) : 0 < p.thickness && (a.moveTo(d, c + n),
            a.lineTo(b, c + n),
            a.moveTo(d, e - n),
            a.lineTo(b, e - n));
            a.stroke();
        ...
        m.prototype._initialize = function() {
            ...
            if (this.options.data) {
                for (var c = 0; c < this.options.data.length; c++)
                    if (a++,
                    !this.options.data[c].type || 0 <= m._supportedChartTypes.indexOf(this.options.data[c].type)) {
        ...
        m.prototype.setLayout = function() {
            ...
            for (d = 0; d < this._axes.length; d++)
                if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
                    u ? (this._breaksCanvas = sa(this.width, this.height, !0),
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                for (var f = this.plotInfo.plotTypes[d], p = 0; p < f.plotUnits.length; p++) {
                    var l = f.plotUnits[p]
                      , A = null;
                    l.targetCanvas = null;
                    this.animatedRender && (l.targetCanvas = sa(this.width, this.height),
                    l.targetCanvasCtx = l.targetCanvas.getContext("2d"),
                    e = l.targetCanvasCtx.miterLimit,
                    l.targetCanvasCtx.miterLimit = 3);
                    "line" === l.type ? A = this.renderLine(l) : "stepLine" === l.type ? A = this.renderStepLine(l) : "spline" === l.type ? A = this.renderSpline(l) : "column" === l.type ? A = this.renderColumn(l) : "bar" === l.type ? A = this.renderBar(l) : "area" === l.type ? A = this.renderArea(l) : "stepArea" === l.type ? A = this.renderStepArea(l) : "splineArea" === l.type ? A = this.renderSplineArea(l) : "stackedColumn" === l.type ? A = this.renderStackedColumn(l) : "stackedColumn100" === l.type ? A = this.renderStackedColumn100(l) : "stackedBar" === l.type ? A = this.renderStackedBar(l) : "stackedBar100" === l.type ? A = this.renderStackedBar100(l) : "stackedArea" === l.type ? A = this.renderStackedArea(l) : "stackedArea100" === l.type ? A = this.renderStackedArea100(l) : "bubble" === l.type ? A = A = this.renderBubble(l) : "scatter" === l.type ? A = this.renderScatter(l) : "pie" === l.type ? this.renderPie(l) : "doughnut" === l.type ? this.renderPie(l) : "funnel" === l.type ? A = this.renderFunnel(l) : "pyramid" === l.type ? A = this.renderFunnel(l) : "candlestick" === l.type ? A = this.renderCandlestick(l) : "ohlc" === l.type ? A = this.renderCandlestick(l) : "rangeColumn" === l.type ? A = this.renderRangeColumn(l) : "error" === l.type ? A = this.renderError(l) : "rangeBar" === l.type ? A = this.renderRangeBar(l) : "rangeArea" === l.type ? A = this.renderRangeArea(l) : "rangeSplineArea" === l.type ? A = this.renderRangeSplineArea(l) : "waterfall" === l.type ? A = this.renderWaterfall(l) : "boxAndWhisker" === l.type && (A = this.renderBoxAndWhisker(l));
            ...
            if (0 < c.length)
                ...
                if (n._breaksCanvas)
                    if (u)
                        ...
                        for (h = 0; h < n._axes.length; h++)
                            n._axes[h].createMask();
        ...
        m.prototype.categoriseDataSeries = function() {
            for (var a = "", d = 0; d < this.data.length; d++)
                if (a = this.data[d],
                a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= m._supportedChartTypes.indexOf(a.type)) {
        ...
        m.prototype._processMultiseriesPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var l = this.data[a.dataSeriesIndexes[p]], A = 0, h = !1, n = !1, r;
                    ...
                    if (l.dataPoints[A].x && l.dataPoints[A].x.getTime || "dateTime" === l.xValueType)
                        f = !0;
                    for (A = 0; A < l.dataPoints.length; A++) {
                        "undefined" === typeof l.dataPoints[A].x && (l.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0));
                        l.dataPoints[A].x.getTime ? (f = !0,
                        b = l.dataPoints[A].x.getTime()) : b = l.dataPoints[A].x;
                        e = l.dataPoints[A].y;
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        ...
                        if (0 < A) {
                            ...
                            null !== e && null !== l.dataPoints[A - 1].y && (a.axisY.logarithmic ? (w = e / l.dataPoints[A - 1].y,
                            1 > w && (w = 1 / w),
                            d.minDiff > w && 1 !== w && (d.minDiff = w)) : (w = e - l.dataPoints[A - 1].y,
                            0 > w && (w *= -1),
                        ...
                        if (b < q && !h)
                            ...
                            null === e ? c.viewPortMin === b && r < b && (c.viewPortMin = r) : (e < d.viewPortMin && "number" === typeof e && (d.viewPortMin = e),
        ...
        m.prototype._processStackedPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = [], l = [], A = Infinity, h = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var r = this.data[a.dataSeriesIndexes[n]], q = 0, g = !1, w = !1, k;
                    if ("normal" === r.axisPlacement || "xySwapped" === r.axisPlacement)
                        var m = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity
                    ...
                    for (q = 0; q < r.dataPoints.length; q++) {
                        ...
                        if (0 < q) {
                            ...
                            null !== e && null !== r.dataPoints[q - 1].y && (a.axisY.logarithmic ? 0 < e && (x = e / r.dataPoints[q - 1].y,
                            1 > x && (x = 1 / x),
                            d.minDiff > x && 1 !== x && (d.minDiff = x)) : (x = e - r.dataPoints[q - 1].y,
                            0 > x && (x *= -1),
                            d.minDiff > x && 0 !== x && (d.minDiff = x)))
                        }
                        if (b < m && !g)
                            null !== r.dataPoints[q].y && (k = b);
                        else {
                            if (!g && (g = !0,
                            0 < q)) {
                                q -= 2;
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === r.dataPoints[q].y ? c.viewPortMin === b && k < b && (c.viewPortMin = k) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e,
                            0 <= e ? p[b] ? p[b] += e : (p[b] = e,
                            A = Math.min(e, A)) : l[b] ? l[b] += e : (l[b] = e,
                            h = Math.max(e, h)))
                        }
                    }
                    a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) && (d.dataPointYPositiveSums ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, p),
                    d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, l)) : (d.dataPointYPositiveSums = p,
                    d.dataPointYNegativeSums = l));
                    r.axisX.valueType = r.xValueType = f ? "dateTime" : "number"
                }
                for (q in p)
                    p.hasOwnProperty(q) && !isNaN(q) && (a = p[q],
                    a < d.min && (d.min = Math.min(a, A)),
                    a > d.max && (d.max = a),
                    q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, A)),
                    a > d.viewPortMax && (d.viewPortMax = a)));
                for (q in l)
                    l.hasOwnProperty(q) && !isNaN(q) && (a = l[q],
                    a < d.min && (d.min = a),
        ...
        m.prototype._processStacked100PlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = !1, l = !1, A = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var n = this.data[a.dataSeriesIndexes[h]], r = 0, q = !1, g = !1, w;
                    ...
                    for (r = 0; r < n.dataPoints.length; r++) {
                        ...
                        if (0 < r) {
                            ...
                            s(e) || null === n.dataPoints[r - 1].y || (a.axisY.logarithmic ? 0 < e && (t = e / n.dataPoints[r - 1].y,
                            1 > t && (t = 1 / t),
                            d.minDiff > t && 1 !== t && (d.minDiff = t)) : (t = e - n.dataPoints[r - 1].y,
                            0 > t && (t *= -1),
                        ...
                        if (b < k && !q)
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e ? c.viewPortMin === b && w < b && (c.viewPortMin = w) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e,
                            0 <= e ? p = !0 : 0 > e && (l = !0),
                ...
                d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : p && !l ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
                d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : p && l ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
                d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !p && l && (d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1),
        ...
        m.prototype._processMultiYPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, p, l = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
                    var h = this.data[a.dataSeriesIndexes[A]], n = 0, r = !1, q = !1, g, w, k;
                    ...
                    for (n = 0; n < h.dataPoints.length; n++) {
                        ...
                        h.dataPoints[n].x.getTime ? (l = !0,
                        b = h.dataPoints[n].x.getTime()) : b = h.dataPoints[n].x;
                        ...
                        f < d.min && (d.min = f);
                        p > d.max && (d.max = p);
                        0 < n && (a.axisX.logarithmic ? (w = b / h.dataPoints[n - 1].x,
                        1 > w && (w = 1 / w),
                        c.minDiff > w && 1 !== w && (c.minDiff = w)) : (w = b - h.dataPoints[n - 1].x,
                        0 > w && (w *= -1),
                        c.minDiff > w && 0 !== w && (c.minDiff = w)),
                        e && (null !== e[0] && h.dataPoints[n - 1].y && null !== h.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (w = e[0] / h.dataPoints[n - 1].y[0],
                        1 > w && (w = 1 / w),
                        d.minDiff > w && 1 !== w && (d.minDiff = w)) : (w = e[0] - h.dataPoints[n - 1].y[0],
                        0 > w && (w *= -1),
                        d.minDiff > w && 0 !== w && (d.minDiff = w))));
                        if (!(b < m) || r) {
                            if (!r && (r = !0,
            ...
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (l.dataPoints[A].x && l.dataPoints[A].x.getTime || "dateTime" === l.xValueType)
                        f = !0;
                    for (A = 0; A < l.dataPoints.length; A++)
                        "undefined" !== typeof l.dataPoints[A].isCumulativeSum && !0 === l.dataPoints[A].isCumulativeSum ? (l.dataPointEOs[A].cumulativeSumYStartValue = 0,
                        l.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum,
                        l.dataPoints[A].y = 0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum) : "undefined" !== typeof l.dataPoints[A].isIntermediateSum && !0 === l.dataPoints[A].isIntermediateSum ? (l.dataPointEOs[A].cumulativeSumYStartValue = r,
                        l.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum,
                        l.dataPoints[A].y = 0 === A ? 0 : b,
                        r = 0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum,
                        b = 0) : (e = "number" !== typeof l.dataPoints[A].y ? 0 : l.dataPoints[A].y,
                        l.dataPointEOs[A].cumulativeSumYStartValue = 0 === A ? 0 : l.dataPointEOs[A - 1].cumulativeSum,
                        l.dataPointEOs[A].cumulativeSum = 0 === A ? e : l.dataPointEOs[A - 1].cumulativeSum + e,
                        b += e);
                    for (A = 0; A < l.dataPoints.length; A++)
                        if ("undefined" === typeof l.dataPoints[A].x && (l.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)),
                        l.dataPoints[A].x.getTime ? (f = !0,
                        b = l.dataPoints[A].x.getTime()) : b = l.dataPoints[A].x,
                        e = l.dataPoints[A].y,
                        b < c.min && (c.min = b),
                        b > c.max && (c.max = b),
                        l.dataPointEOs[A].cumulativeSum < d.min && (d.min = l.dataPointEOs[A].cumulativeSum),
                        l.dataPointEOs[A].cumulativeSum > d.max && (d.max = l.dataPointEOs[A].cumulativeSum),
                        0 < A && (a.axisX.logarithmic ? (r = b / l.dataPoints[A - 1].x,
                        1 > r && (r = 1 / r),
                        c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = b - l.dataPoints[A - 1].x,
                        0 > r && (r *= -1),
                        c.minDiff > r && 0 !== r && (c.minDiff = r)),
                        null !== e && null !== l.dataPoints[A - 1].y && (a.axisY.logarithmic ? (e = l.dataPointEOs[A].cumulativeSum / l.dataPointEOs[A - 1].cumulativeSum,
                        1 > e && (e = 1 / e),
                        d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = l.dataPointEOs[A].cumulativeSum - l.dataPointEOs[A - 1].cumulativeSum,
                        0 > e && (e *= -1),
                        ...
                        !(b < q) || h) {
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < A && (l.dataPointEOs[A - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = l.dataPointEOs[A - 1].cumulativeSum),
                            l.dataPointEOs[A - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = l.dataPointEOs[A - 1].cumulativeSum));
        ...
        m.prototype.calculateAutoBreaks = function() {
                        ...
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, p = f.max, l = d.min, n = d.max, f = f._dataRanges, d = d._dataRanges, q, r = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
                            ...
                            if (!(4 > k.dataPoints.length))
                                for (r = 0; r < k.dataPoints.length; r++)
                                    if (b && (q = (p + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100,
                                    g = k.dataPoints[r].x.getTime ? k.dataPoints[r].x.getTime() : k.dataPoints[r].x,
                                    q = Math.floor((g - h) / q),
                                    g < f[q].min && (f[q].min = g),
                                    g > f[q].max && (f[q].max = g)),
                                    c) {
                    ...
                    for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, h = 0, p = 0; p < a.dataSeriesIndexes.length; p++) {
                        ...
                        if (!(4 > l.dataPoints.length))
                            for (h = 0; h < l.dataPoints.length; h++)
                                ...
                                b = l.dataPoints[h].x.getTime ? l.dataPoints[h].x.getTime() : l.dataPoints[h].x,
                                g = Math.floor((b - c) / g),
                                b < f[g].min && (f[g].min = b),
                                b > f[g].max && (f[g].max = b)
                    }
            ...
            for (var b, e = this, f = !1, p = 0; p < this._axes.length; p++)
                if (this._axes[p].scaleBreaks && this._axes[p].scaleBreaks.autoCalculate && 1 <= this._axes[p].scaleBreaks.maxNumberOfAutoBreaks) {
                    ...
                    for (var l = 0; l < 100 / Math.max(parseFloat(this._axes[p].scaleBreaks.collapsibleThreshold) || 10, 10); l++)
            ...
            if (f) {
                for (p = 0; p < this.plotInfo.plotTypes.length; p++)
                    for (f = this.plotInfo.plotTypes[p],
                    l = 0; l < f.plotUnits.length; l++)
                        b = f.plotUnits[l],
                ...
                for (p = 0; p < this._axes.length; p++)
                    if (this._axes[p].dataInfo._dataRanges) {
                        ...
                        if (this._axes[p].dataInfo.dataPointYNegativeSums) {
                            ...
                            n = h;
                            for (l in q)
                                q.hasOwnProperty(l) && !isNaN(l) && (r = -1 * q[l],
                                s(r) || (g = Math.floor((r - A) / b),
                                r < n[g].min && (n[g].min = r),
                                r > n[g].max && (n[g].max = r)));
                        ...
                        if (this._axes[p].scaleBreaks.customBreaks)
                            for (l = 0; l < this._axes[p].scaleBreaks.customBreaks.length; l++)
                                for (b = 0; b < f.length; b++)
                                    if (this._axes[p].scaleBreaks.customBreaks[l].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].endValue || this._axes[p].scaleBreaks.customBreaks[l].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].endValue || f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].startValue && this._axes[p].scaleBreaks.customBreaks[l].startValue <= f[b].end || f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].endValue && this._axes[p].scaleBreaks.customBreaks[l].endValue <= f[b].end)
                                        f.splice(b, 1),
                                        b--;
                        f.sort(function(a, b) {
                            return b.diff - a.diff
                        });
                        for (l = 0; l < Math.min(f.length, this._axes[p].scaleBreaks.maxNumberOfAutoBreaks); l++)
                            b = a(f[l].start, f[l].end, this._axes[p].logarithmic ? this._axes[p].dataInfo.max / this._axes[p].dataInfo.min : this._axes[p].dataInfo.max - this._axes[p].dataInfo.min, this._axes[p].logarithmic),
                            this._axes[p].scaleBreaks.autoBreaks.push(new U(this,"autoBreaks",b,l,++this._eventManager.lastObjectId,this._axes[p].scaleBreaks)),
        ...
        m.prototype.getDataPointAtXY = function(a, d, c) {
            ...
            for (c = 0; c < b.length; c++)
                if ("line" === b[c].dataSeries.type || "stepLine" === b[c].dataSeries.type || "area" === b[c].dataSeries.type || "stepArea" === b[c].dataSeries.type)
                    if (e = la("markerSize", b[c].dataPoint, b[c].dataSeries) || 8,
                    b[c].distance <= e / 2) {
                        d = !0;
                        break
                    }
        ...
        m.prototype.getObjectAtXY = function(a, d, c) {
            ...
            if (c = this.getDataPointAtXY(a, d, c || !1))
                ...
                b = Xa(a, d, this._eventManager.ghostCtx);
            else
            ...
            if (a.changedTouches && this.interactivityEnabled) {
                ...
                if (!(c && 1 < c.length)) {
                    ...
                    try {
                        ...
                        if (1 < Math.abs(p) && this._lastTouchData.scroll || 5 < Math.abs(p) && 250 > f)
                    ...
                    if (this._lastTouchData.scroll && this.zoomEnabled)
                        ...
                        for (c = 0; c < d.length; c++)
                            ...
                            p.initMouseEvent(e, !0, !0, window, 1, b.screenX, b.screenY, b.clientX, b.clientY, !1, !1, !1, !1, 0, null),
        ...
        m.prototype._mouseEventHandler = function(a) {
            ...
            m.capturedEventParam && (b = m.capturedEventParam,
            "mouseup" === c && (m.capturedEventParam = null,
                        ...
                        for (var f = 0; f < this._events.length; f++)
                            if (this._events[f].hasOwnProperty(c))
                                ...
                                d.x >= e.x1 && d.x <= e.x2 && d.y >= e.y1 && d.y <= e.y2) {
                                    ...
                                    "mousedown" === c && !0 === b.capture ? (m.capturedEventParam = b,
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    if (this.panEnabled)
                        for (e = f = 0; e < this._axes.length; e++)
                            ...
                            p = !0) : c.viewportMaximum > c.maximum && (f = c.viewportMaximum / c.maximum,
                            c.sessionVariables.newViewportMinimum = c.viewportMinimum / f,
                            c.sessionVariables.newViewportMaximum = c.viewportMaximum / f,
                            p = !0) : c.viewportMinimum < c.minimum ? (f = c.minimum - c.viewportMinimum,
                            c.sessionVariables.newViewportMinimum = c.viewportMinimum + f,
                            c.sessionVariables.newViewportMaximum = c.viewportMaximum + f,
                            p = !0) : c.viewportMaximum > c.maximum && (f = c.viewportMaximum - c.maximum,
                            c.sessionVariables.newViewportMinimum = c.viewportMinimum - f,
                    ...
                    p && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (Ja(this._zoomButton, this._resetButton),
                    ua(this, this._zoomButton, "pan"),
                    ua(this, this._resetButton, "reset")))
                }
            }
                ...
                if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                    if (this.panEnabled)
                        ...
                        p._panTimerId = setTimeout(function(b, c, e, f) {
                            return function() {
                                p._zoomPanToSelectedRegion(b, c, e, f, !0) && (p._dispatchRangeEvent("rangeChanging", "pan"),
                                p.stockChart && (p.stockChart.navigator && p.stockChart.navigator.enabled) && (p.stockChart._rangeEventParameter.type = "rangeChanging",
                                p.stockChart.dispatchEvent("rangeChanging", p.stockChart._rangeEventParameter, p.stockChart)),
                                p.render(),
                                p._dispatchRangeEvent("rangeChanged", "pan"),
                                p.stockChart && (p.stockChart.navigator && p.stockChart.navigator.enabled) && (p.stockChart._rangeEventParameter.type = "rangeChanged",
                                p.stockChart.dispatchEvent("rangeChanged", p.stockChart._rangeEventParameter, p.stockChart)),
                        ...
                        this.validateRegion(b, l, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(),
        ...
        m.prototype.validateRegion = function(a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), p = 0 <= this.zoomType.indexOf("y"), l = !1, A = [], h = [], n = [], r = 0; r < this._axes.length; r++)
                ("axisX" === this._axes[r].type && f || "axisY" === this._axes[r].type && p) && h.push(this._axes[r]);
            for (p = 0; p < h.length; p++) {
                ...
                if (r.scaleBreaks)
                    for (w = 0; !f && w < r.scaleBreaks._appliedBreaks.length; w++)
                        f = r.scaleBreaks._appliedBreaks[w].startValue <= q && r.scaleBreaks._appliedBreaks[w].endValue >= g;
                if (isFinite(r.dataInfo.minDiff))
                    if (w = r.getApparentDifference(q, g, null, !0),
                    !(f || !(this.panEnabled && r.scaleBreaks && r.scaleBreaks._appliedBreaks.length) && (r.logarithmic && w < Math.pow(r.dataInfo.minDiff, 3) || !r.logarithmic && w < 3 * Math.abs(r.dataInfo.minDiff)) || q < r.minimum || g > r.maximum))
                        A.push(r),
                        n.push({
                            val1: q,
                            val2: g
        ...
        m.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var h = this._indexLabels[a], n = h.chartType.toLowerCase(), r, q, l = la("indexLabelFontColor", h.dataPoint, h.dataSeries), A = la("indexLabelFontSize", h.dataPoint, h.dataSeries);
                ...
                if (null !== z && "" !== z) {
                    ...
                    if ("stackedarea100" === n) {
                        if (h.point.x < c.x1 || h.point.x > c.x2 || h.point.y < c.y1 - 1 || h.point.y > c.y2 + 1)
                            continue
                    } else if ("rangearea" === n || "rangesplinearea" === n) {
                        if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x > B.viewportMaximum || Math.max.apply(null, h.dataPoint.y) < C.viewportMinimum || Math.min.apply(null, h.dataPoint.y) > C.viewportMaximum)
                            continue
                    } else if (0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("bubble") || 0 <= n.indexOf("scatter")) {
                        if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x > B.viewportMaximum || h.dataPoint.y < C.viewportMinimum || h.dataPoint.y > C.viewportMaximum)
                            continue
                    } else if (0 <= n.indexOf("column") || "waterfall" === n || "error" === n && !h.axisSwapped) {
                        if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x > B.viewportMaximum || h.bounds.y1 > c.y2 || h.bounds.y2 < c.y1)
                            continue
                    } else if (0 <= n.indexOf("bar") || "error" === n) {
                        if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x > B.viewportMaximum || h.bounds.x1 > c.x2 || h.bounds.x2 < c.x1)
                            continue
                    } else if ("candlestick" === n || "ohlc" === n) {
                        if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x > B.viewportMaximum || Math.max.apply(null, h.dataPoint.y) < C.viewportMinimum || Math.min.apply(null, h.dataPoint.y) > C.viewportMaximum)
                            continue
                    } else if (h.dataPoint.x < B.viewportMinimum || h.dataPoint.x > B.viewportMaximum)
                        continue;
                    e = p = 2;
                    "horizontal" === x ? (l = g.width,
                    A = g.height) : (A = g.width,
                    l = g.height);
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== t ? (e = c.y1,
                        f = c.y2,
                        0 < F ? (q = h.point.y - A - p - b,
                        q < e && (q = "auto" === t ? Math.max(h.point.y, e) + p + b : e + p + b,
                        v = q + A > h.point.y)) : (q = h.point.y + p + b,
                        q > f - A - p - b && (q = "auto" === t ? Math.min(h.point.y, f) - A - p - b : f - A - p - b,
                        v = q < h.point.y))) : (e = Math.max(h.bounds.y1, c.y1),
                        f = Math.min(h.bounds.y2, c.y2),
                        b = 0 <= n.indexOf("range") || "error" === n ? 0 < F ? Math.max(h.bounds.y1, c.y1) + A / 2 + p : Math.min(h.bounds.y2, c.y2) - A / 2 - p : (Math.max(h.bounds.y1, c.y1) + Math.min(h.bounds.y2, c.y2)) / 2,
                        0 < F ? (q = Math.max(h.point.y, b) - A / 2,
                        q < e && ("bubble" === n || "scatter" === n) && (q = Math.max(h.point.y - A - p, c.y1 + p))) : (q = Math.min(h.point.y, b) - A / 2,
                        q > f - A - p && ("bubble" === n || "scatter" === n) && (q = Math.min(h.point.y + p, c.y2 - A - p))),
                        q = Math.min(q, f - A))
                    } else
                        0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("scatter") ? (t = "auto",
                        e = 4) : 0 <= n.indexOf("stacked") ? "auto" === t && (t = "inside") : "bubble" === n && (t = "inside"),
                        q = h.point.y - A / 2,
                        "inside" !== t ? (p = c.x1,
                        f = c.x2,
                        0 > F ? (r = h.point.x - l - e - b,
                        r < p && (r = "auto" === t ? Math.max(h.point.x, p) + e + b : p + e + b,
                        v = r + l > h.point.x)) : (r = h.point.x + e + b,
                        r > f - l - e - b && (r = "auto" === t ? Math.min(h.point.x, f) - l - e - b : f - l - e - b,
                        v = r < h.point.x))) : (p = Math.max(h.bounds.x1, c.x1),
                        Math.min(h.bounds.x2, c.x2),
                        b = 0 <= n.indexOf("range") || "error" === n ? 0 > F ? Math.max(h.bounds.x1, c.x1) + l / 2 + e : Math.min(h.bounds.x2, c.x2) - l / 2 - e : (Math.max(h.bounds.x1, c.x1) + Math.min(h.bounds.x2, c.x2)) / 2,
                        r = 0 > F ? Math.max(h.point.x, b) - l / 2 : Math.min(h.point.x, b) - l / 2,
                        r = Math.max(r, p));
                    "vertical" === x && (q += A);
                    g.x = r;
                    g.y = q;
                    g.render(!0);
                    m && ("inside" !== t && (0 > n.indexOf("bar") && ("error" !== n || !h.axisSwapped) && h.point.x > c.x1 && h.point.x < c.x2 || !v) && (0 > n.indexOf("column") && ("error" !== n || h.axisSwapped) && h.point.y > c.y1 && h.point.y < c.y2 || !v)) && (d.lineWidth = m,
                    d.strokeStyle = k ? k : "gray",
                    d.setLineDash && d.setLineDash(N(w, m)),
                    d.beginPath(),
                    d.moveTo(h.point.x, h.point.y),
                    0 <= n.indexOf("bar") || "error" === n && h.axisSwapped ? d.lineTo(r + (0 < h.direction ? 0 : l), q + ("horizontal" === x ? A : -A) / 2) : 0 <= n.indexOf("column") || "error" === n && !h.axisSwapped ? d.lineTo(r + l / 2, q + ((0 < h.direction ? A : -A) + ("horizontal" === x ? A : -A)) / 2) : d.lineTo(r + l / 2, q + ((q < h.point.y ? A : -A) + ("horizontal" === x ? A : -A)) / 2),
                    d.stroke())
                }
            }
            d = {
            ...
            for (a = 0; a < this._indexLabels.length; a++)
                ...
                g = la("indexLabelBackgroundColor", h.dataPoint, h.dataSeries),
                h.dataSeries.indexLabelBackgroundColor = s(g) ? u ? "transparent" : null : g;
            return d
        }
        ;
                ...
                for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < n.length) {
                        for (var F = !1, t = 0; t < n.length; t++)
                            if (x = n[t].x.getTime ? n[t].x.getTime() : n[t].x,
                            !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !F)))
                                if ("number" !== typeof n[t].y)
                                    0 < t && !(h.connectNullData || F || m) && (c.stroke(),
                                    u && b.stroke()),
                                    F = !0;
                                else {
                                    ...
                                    m || F ? (!m && h.connectNullData ? (c.setLineDash && (h.options.nullDataLineDashType || r === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (c.stroke(),
                                    c.beginPath(),
                                    c.moveTo(p.x, p.y),
                                    r = h.nullDataLineDashType,
                                    c.setLineDash(q)),
                                    c.lineTo(x, s),
                                    u && b.lineTo(x, s)) : (c.beginPath(),
                                    c.moveTo(x, s),
                                    u && (b.beginPath(),
                                    b.moveTo(x, s))),
                                    F = m = !1) : (c.lineTo(x, s),
                                    ...
                                    t < n.length - 1 && (k !== (n[t].lineColor || w) || r !== (n[t].lineDashType || h.lineDashType)) && (c.stroke(),
                                    c.beginPath(),
                                    c.moveTo(x, s),
                                    k = n[t].lineColor || w,
                                    c.strokeStyle = k,
                                    c.setLineDash && (n[t].lineDashType ? (r = n[t].lineDashType,
                                    c.setLineDash(N(r, h.lineThickness))) : (r = h.lineDashType,
                                    c.setLineDash(g))));
        ...
        m.prototype.renderStepLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < n.length) {
                        for (var F = !1, t = 0; t < n.length; t++)
                            if (x = n[t].getTime ? n[t].x.getTime() : n[t].x,
                            !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !F)))
                                if ("number" !== typeof n[t].y)
                                    0 < t && !(h.connectNullData || F || m) && (c.stroke(),
                                    u && b.stroke()),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < n.length)
                        for (x = !1,
                        m = 0; m < n.length; m++)
                            if (t = n[m].getTime ? n[m].x.getTime() : n[m].x,
                            !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x)))
                                if ("number" !== typeof n[m].y)
                                    0 < m && !x && (h.connectNullData ? b.setLineDash && (0 < s.length && (h.options.nullDataLineDashType || !n[m - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = q,
                                    r = h.nullDataLineDashType) : (d(s),
                                    s = [])),
                                    x = !0;
                                else {
                                    ...
                                    m < n.length - 1 && (k !== (n[m].lineColor || w) || r !== (n[m].lineDashType || h.lineDashType)) && (k = n[m].lineColor || w,
                                    s[s.length - 1].newStrokeStyle = k,
                                    b.setLineDash && (n[m].lineDashType ? (r = n[m].lineDashType,
                                    s[s.length - 1].newLineDashArray = N(r, h.lineThickness)) : (r = h.lineDashType,
        ...
        m.prototype.renderColumn = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = u ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, p, l, A, h = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, r = a.axisX.dataInfo.minDiff;
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < w.length)
                        for (var k = 5 < r && g.bevelEnabled ? !0 : !1, f = 0; f < w.length; f++)
                            if (w[f].getTime ? A = w[f].x.getTime() : A = w[f].x,
                            !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof w[f].y) {
                                ...
                                var m = a.axisX.reversed ? p - r << 0 : p + r << 0, t;
                                0 <= w[f].y ? t = h : (t = l,
                                l = h);
                                l > t && (b = l,
                                l = t,
                                ...
                                ca(c, p, l, m, t, b, 0, null, k && 0 <= w[f].y, 0 > w[f].y && k, !1, !1, g.fillOpacity);
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
        ...
        m.prototype.renderStackedColumn = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = u ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = [], p = [], l = [], A = [], h = 0, n, r, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), h = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x,
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                n = a.axisX.convertValueToPixel(b);
                                var s = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, F = s + g << 0, B;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y)
                                    l[b] = t[h].y + (l[b] ? l[b] : 0),
                                    0 < l[b] && (r = a.axisY.convertValueToPixel(l[b]),
                                    ...
                                    p[b] = B;
                                else if (r = a.axisY.convertValueToPixel(t[h].y),
                                0 <= t[h].y) {
                        ...
                        for (var x = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++)
                            ...
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) {
                                    ...
                                    r = p[b] ? p[b] : q,
                                    p[b] = B;
                                else if (r = a.axisY.convertValueToPixel(r),
                                0 <= t[h].y) {
                                    var C = "undefined" !== typeof f[b] ? f[b] : 0;
                                    r -= C;
                                    B = q - C;
                                    ...
                                    B = r + C,
                                    r = q + C,
                                    a.dataSeriesIndexes.length - 1 === w && 1 >= Math.abs(e.y2 - B) && (B = e.y2),
                                    p[b] = C + (B - r);
                                b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length];
                                ca(c, s, r, F, B, b, 0, null, x && 0 <= t[h].y, 0 > t[h].y && x, !1, !1, m.fillOpacity);
                                b = m.dataPointIds[h];
        ...
        m.prototype.renderBar = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = u ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, p, l, A, h = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, r = a.axisX.dataInfo.minDiff;
                isFinite(r) || (r = 0.3 * Math.abs(a.axisX.range));
                    ...
                    if (0 < w.length) {
                        ...
                        for (f = 0; f < w.length; f++)
                            ...
                            !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof w[f].y) {
                                ...
                                var m = a.axisX.reversed ? l - r << 0 : l + r << 0, t;
                                0 <= w[f].y ? t = h : (t = p,
                                p = h);
                                b = w[f].color ? w[f].color : g._colorSet[f % g._colorSet.length];
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++)
                            ...
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                ...
                                var s = r - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, F = s + g << 0, B;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y)
                                    l[b] = t[h].y + (l[b] ? l[b] : 0),
                                    0 < l[b] && (B = f[b] ? f[b] : q,
                                ...
                                else if (n = a.axisY.convertValueToPixel(t[h].y),
                                0 <= t[h].y) {
                                    var C = f[b] ? f[b] : 0;
                                    B = q + C;
                                    n += C;
                        ...
                        for (h = 0; h < t.length; h++)
                            ...
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                ...
                                0 <= t[h].y) {
                                    ...
                                    z = n - C,
                                    n = q - C,
                                    a.dataSeriesIndexes.length - 1 === w && 1 >= Math.abs(e.x1 - z) && (z = e.x1),
                                    p[b] = C + (n - z);
                                b = t[h].color ? t[h].color : m._colorSet[h % m._colorSet.length];
        ...
        m.prototype.renderArea = function(a) {
            var d, c;
            function b() {
                B && (0 < g.lineThickness && f.stroke(),
                a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? F = z : 0 > a.axisY.viewportMaximum ? F = l.y1 : 0 < a.axisY.viewportMinimum && (F = z),
                f.lineTo(m, F),
                f.lineTo(B.x, F),
                f.closePath(),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var p = this._eventManager.ghostCtx, l = a.axisY.lineCoordinates, A = [], h = this.plotArea, n;
                f.save();
                u && p.save();
                f.beginPath();
                ...
                f.clip();
                u && (p.beginPath(),
                p.rect(h.x1, h.y1, h.width, h.height),
                p.clip());
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    A = [];
                    d = !0;
                    var k = 0, m, t, s, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), F, B = null;
                    if (0 < w.length) {
                        ...
                        for (var ja = !0; k < w.length; k++)
                            if (s = w[k].x.getTime ? w[k].x.getTime() : w[k].x,
                            !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja)))
                                if ("number" !== typeof w[k].y)
                                    g.connectNullData || (ja || d) || b(),
                                    ja = !0;
                                else {
                                    m = a.axisX.convertValueToPixel(s);
                                    t = a.axisY.convertValueToPixel(w[k].y);
                                    d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m,
                                    c = t,
                                    m = n.x,
                                    t = n.y,
                                    b(),
                                    ...
                                    k < w.length - 1 && (y !== (w[k].lineColor || v) || c !== (w[k].lineDashType || g.lineDashType)) && (b(),
                                    y = w[k].lineColor || v,
                                    f.strokeStyle = y,
                                    f.setLineDash && (w[k].lineDashType ? (c = w[k].lineDashType,
                                    ...
                                    0 !== w[k].markerSize && (0 < w[k].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(k, m, t, f),
                                    A.push(s),
                                    Z = P(Z),
                                    u && A.push({
                                        x: m,
        ...
        m.prototype.renderSplineArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                b.clip();
                u && (e.beginPath(),
                e.rect(l.x1, l.y1, l.width, l.height),
                e.clip());
                for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                    ...
                    p = P(p);
                    e.fillStyle = p;
                    var p = [], q = 0, g, w, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), m, t = null, s = [];
                    if (0 < r.length) {
                        ...
                        for (w = !1; q < r.length; q++)
                            if (g = r[q].x.getTime ? r[q].x.getTime() : r[q].x,
                            !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !w)))
                                if ("number" !== typeof r[q].y)
                                    0 < q && !w && (n.connectNullData ? b.setLineDash && (0 < s.length && (n.options.nullDataLineDashType || !r[q - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = y,
                                    C = n.nullDataLineDashType) : (d(),
                                    s = [])),
                                    w = !0;
                                else {
                                    ...
                                    q < r.length - 1 && (B !== (r[q].lineColor || F) || C !== (r[q].lineDashType || n.lineDashType)) && (B = r[q].lineColor || F,
                                    s[s.length - 1].newStrokeStyle = B,
                                    b.setLineDash && (r[q].lineDashType ? (C = r[q].lineDashType,
                                    s[s.length - 1].newLineDashArray = N(C, n.lineThickness)) : (C = n.lineDashType,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < w.length) {
                        ...
                        for (; k < w.length; k++)
                            if (s = w[k].x.getTime ? w[k].x.getTime() : w[k].x,
                            !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                                var Z = t;
                                "number" !== typeof w[k].y ? (g.connectNullData || (c || d) || b(),
                                c = !0) : (m = a.axisX.convertValueToPixel(s),
                                t = a.axisY.convertValueToPixel(w[k].y),
                                d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || S === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m,
                                c = t,
                                m = n.x,
                                t = n.y,
                                b(),
                                ...
                                k < w.length - 1 && (y !== (w[k].lineColor || v) || S !== (w[k].lineDashType || g.lineDashType)) && (b(),
                                y = w[k].lineColor || v,
                                f.strokeStyle = y,
                                f.setLineDash && (w[k].lineDashType ? (S = w[k].lineDashType,
                                f.setLineDash(N(S, g.lineThickness))) : (S = g.lineDashType,
                                f.setLineDash(D)))),
                                s = g.dataPointIds[k],
                                this._eventManager.objectMap[s] = {
                                    id: s,
                                ...
                                0 !== w[k].markerSize && (0 < w[k].markerSize || 0 < g.markerSize) && (Z = g.getMarkerProperties(k, m, t, f),
                                A.push(Z),
                                s = P(s),
                                u && A.push({
                                    x: m,
        ...
        m.prototype.renderStackedArea = function(a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx
              , b = u ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, p = [], l = this.plotArea, A = [], h = [], n = [], r = [], q = 0, g, k, m = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s = this._eventManager.ghostCtx, t, x, z;
                u && s.beginPath();
                b.save();
                u && s.save();
                b.beginPath();
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !Z)))
                                if ("number" !== typeof fa.y)
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        r[f] = fa.y + (r[f] ? r[f] : 0);
                                        if (0 >= r[f] && a.axisY.logarithmic)
                                            continue;
                                        k = a.axisY.convertValueToPixel(r[f])
                                    } else
                                        k = a.axisY.convertValueToPixel(fa.y),
                                        k -= ma;
                                    h.push({
                                        x: g,
                                        y: m - ma
                                    ...
                                    A[f] = m - k;
                                    x || Z ? (!x && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || z === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (x = h.pop(),
                                    z = h[h.length - 1],
                                    d(),
                                    b.moveTo(t.x, t.y),
                                    h.push(z),
                                    ...
                                    q < v.length - 1 && (S !== (v[q].lineColor || y) || z !== (v[q].lineDashType || C.lineDashType)) && (d(),
                                    b.beginPath(),
                                    b.moveTo(g, k),
                                    h.push({
                                        x: g,
                                    ...
                                    S = v[q].lineColor || y,
                                    b.strokeStyle = S,
                                    b.setLineDash && (v[q].lineDashType ? (z = v[q].lineDashType,
                                    b.setLineDash(N(z, C.lineThickness))) : (z = C.lineDashType,
                                    b.setLineDash(D))));
                                    ...
                                    0 <= C.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < C.markerSize) && (ma = C.getMarkerProperties(C.dataPointIndexes[f], g, k, b),
                                    p.push(ma),
                                    f = P(E),
                                    u && p.push({
                                        x: g,
        ...
        m.prototype.renderStackedArea100 = function(a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx
              , b = u ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, p = this.plotArea, l = [], k = [], h = [], n = [], r = [], q = 0, g, w, m, s, t, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), z = this._eventManager.ghostCtx;
                b.save();
                u && z.save();
                b.beginPath();
                ...
                b.clip();
                u && (z.beginPath(),
                z.rect(p.x1, p.y1, p.width, p.height),
                z.clip());
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !Z)))
                                if ("number" !== typeof fa.y)
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        w = a.axisY.convertValueToPixel(ma),
                                        w -= ba;
                                    h.push({
                                        x: g,
                                        y: x - ba
                                    ...
                                    k[f] = x - w;
                                    s || Z ? (!s && C.connectNullData ? (b.setLineDash && (C.options.nullDataLineDashType || t === C.lineDashType && C.lineDashType !== C.nullDataLineDashType) && (s = h.pop(),
                                    t = h[h.length - 1],
                                    d(),
                                    b.moveTo(m.x, m.y),
                                    h.push(t),
                                    ...
                                    q < y.length - 1 && (S !== (y[q].lineColor || D) || t !== (y[q].lineDashType || C.lineDashType)) && (d(),
                                    b.beginPath(),
                                    b.moveTo(g, w),
                                    h.push({
                                        x: g,
                                    ...
                                    S = y[q].lineColor || D,
                                    b.strokeStyle = S,
                                    b.setLineDash && (y[q].lineDashType ? (t = y[q].lineDashType,
                                    b.setLineDash(N(t, C.lineThickness))) : (t = C.lineDashType,
                                    b.setLineDash(E))));
                                    if (0 <= C.dataPointIndexes[f]) {
                                    ...
                                    0 <= C.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < C.markerSize) && (ba = C.getMarkerProperties(q, g, w, b),
                                    l.push(ba),
                                    f = P(G),
                                    u && l.push({
                                        x: g,
        ...
        m.prototype.renderBubble = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++)
                    for (var n = a.dataSeriesIndexes[h], r = this.data[n], q = r.dataPoints, g = 0, e = 0; e < q.length; e++)
                    ...
                    0 < q.length)
                        ...
                        e = 0; e < q.length; e++)
                            ...
                            !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y) {
                                ...
                                (q[e].indexLabel || r.indexLabel || q[e].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "bubble",
                                    dataPoint: q[e],
                                    dataSeries: r,
                                    point: {
                    ...
                    if (0 < n.length) {
                        ...
                        for (var r = 0, q = 0, e = 0; e < n.length; e++)
                            ...
                            !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                                ...
                                c.globalAlpha = 1;
                                Math.sqrt((r - f) * (r - f) + (q - p) * (q - p)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (r = h.dataPointIds[e],
                                ...
                                r = P(r),
                                u && X.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, r, r, g.borderThickness),
                                (n[e].indexLabel || h.indexLabel || n[e].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "scatter",
                                    dataPoint: n[e],
                                    dataSeries: h,
                                    point: {
        ...
        m.prototype.renderCandlestick = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, p = this.plotArea, l = 0, k, h, n, r, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, w = a.axisX.dataInfo.minDiff;
                isFinite(w) || (w = 0.3 * Math.abs(a.axisX.range));
                w = this.options.dataPointWidth ? this.dataPointWidth : 0.7 * p.width * (a.axisX.logarithmic ? Math.log(w) / Math.log(a.axisX.range) : Math.abs(w) / Math.abs(a.axisX.range)) << 0;
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < x.length)
                        for (var z = 5 < w && t.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)
                            if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x,
                            !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3]) {
                                ...
                                "candlestick" === t.type ? (c.moveTo(k - y, n),
                                c.lineTo(k - y, Math.min(h, q)),
                                c.stroke(),
                                c.moveTo(k - y, Math.max(h, q)),
                                c.lineTo(k - y, r),
                                c.stroke(),
                                ca(c, F, Math.min(h, q), B, Math.max(h, q), x[l].y[0] <= x[l].y[3] ? t.risingColor : f, C, e, z, z, !1, !1, t.fillOpacity),
                                u && (e = P(D),
                                b.strokeStyle = e,
                                b.moveTo(k - y, n),
                                ...
                                b.lineTo(k - y, r),
                                b.stroke(),
                                ca(b, F, Math.min(h, q), B, Math.max(h, q), e, 0, null, !1, !1, !1, !1))) : "ohlc" === t.type && (c.moveTo(k - y, n),
                                c.lineTo(k - y, r),
                                c.stroke(),
                                c.beginPath(),
                                c.moveTo(k, h),
        ...
        m.prototype.renderBoxAndWhisker = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              ...
              , b = this._eventManager.ghostCtx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = this.plotArea, p = 0, l, k, h, n, r, q, g, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, p = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, w = a.axisX.dataInfo.minDiff;
                isFinite(w) || (w = 0.3 * Math.abs(a.axisX.range));
                ...
                for (var m = !1, m = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < z.length)
                        for (var F = 5 < w && x.bevelEnabled ? !0 : !1, p = 0; p < z.length; p++)
                            if (z[p].getTime ? g = z[p].x.getTime() : g = z[p].x,
                            !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(z[p].y) && z[p].y.length && "number" === typeof z[p].y[0] && "number" === typeof z[p].y[1] && "number" === typeof z[p].y[2] && "number" === typeof z[p].y[3] && "number" === typeof z[p].y[4] && 5 === z[p].y.length) {
                                ...
                                var B = l - w / 2 << 0
                                  ...
                                  , Z = "number" === typeof Z ? 0 >= Z ? 0 : Z >= w ? w : Z : "string" === typeof Z ? parseInt(Z) * w / 100 > w ? w : parseInt(Z) * w / 100 : w
                                  ...
                                  , M = "number" === typeof z[p].lineThickness ? z[p].lineThickness : "number" === typeof x.options.lineThickness ? x.lineThickness : y
                                ...
                                c.lineWidth = y;
                                c.strokeStyle = e;
                                c.rect(B - D, Math.min(h, n) - D, C - B + 2 * D, Math.max(h, n) - Math.min(h, n) + 2 * D);
                                c.stroke();
                                c.save();
                                0 < M && (c.beginPath(),
                                c.globalAlpha = 1,
                                ...
                                b.strokeStyle = e,
                                b.lineWidth = ba,
                                0 < ba && (b.moveTo(l - D - G, h),
                                b.lineTo(l - D - G, Math.max(k, r)),
                                b.stroke(),
                                b.moveTo(l - D - G, Math.min(k, r)),
                                b.lineTo(l - D - G, n),
                                b.stroke()),
                                ca(b, B, Math.max(h, n), C, Math.min(h, n), e, 0, null, !1, !1, !1, !1),
                                0 < R && (b.beginPath(),
                                b.lineWidth = R,
                                b.moveTo(l + Z / 2, r - fa),
                                b.lineTo(l - Z / 2, r - fa),
        ...
        m.prototype.renderRangeColumn = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = u ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, p, l, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < g.length)
                        for (var m = 5 < h && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            if (g[f].getTime ? k = g[f].x.getTime() : k = g[f].x,
                            !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
        ...
        m.prototype.renderError = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = !1, p = this.plotArea, l = 0, k, h, n, r, q, g, m, ka = a.axisX.dataInfo.minDiff;
                ...
                for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                    var z = a.dataSeriesIndexes[x]
                      ...
                      , D = 0;
                    if (C)
                        for (e = F._linkedSeries.id,
                        t = 0; t < e; t++)
                            !this.data[t].type.match(/(bar|column)/ig) || !this.data[t].visible || this.data[t].type.match(/(stacked)/ig) && D || (this.data[t].type.match(/(range)/ig) && (f = !0),
                            D++);
                    ...
                    f && (l = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (C ? v : 1))) << 0 : 0.03 * this.width);
                        ...
                        for (var E = F._colorSet, l = 0; l < B.length; l++) {
                            var e = F.lineColor = F.options.color ? F.options.color : E[0]
                              , S = {
                                ...
                                trimLength: s(B[l].whiskerLength) ? s(F.options.whiskerLength) ? 50 : 0 : 0
                            };
                            ...
                            if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && !s(B[l].y) && B[l].y.length && "number" === typeof B[l].y[0] && "number" === typeof B[l].y[1]) {
                                ...
                                b ? r = ja : g = ja;
                                b ? (q = a.axisX.reversed ? h + (C ? v : 1) * t / 2 - (C ? D - 1 : 0) * t << 0 : h - (C ? v : 1) * t / 2 + (C ? D - 1 : 0) * t << 0,
                                g = a.axisX.reversed ? q - t << 0 : q + t << 0) : (n = a.axisX.reversed ? k + (C ? v : 1) * t / 2 - (C ? D - 1 : 0) * t << 0 : k - (C ? v : 1) * t / 2 + (C ? D - 1 : 0) * t << 0,
                                ...
                                y(c, Math.min(n, r), Math.min(q, g), Math.max(r, n), Math.max(g, q), e, S, R, b);
                                u && y(this._eventManager.ghostCtx, n, q, r, g, e, S, R, b);
                                if (B[l].indexLabel || F.indexLabel || B[l].indexLabelFormatter || F.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "error",
                                        dataPoint: B[l],
                                        dataSeries: F,
        ...
        m.prototype.renderRangeBar = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = u ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, p, l, k, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < m.length) {
                        ...
                        for (f = 0; f < m.length; f++)
                            if (m[f].getTime ? h = m[f].x.getTime() : h = m[f].x,
                            !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(m[f].y) && m[f].y.length && "number" === typeof m[f].y[0] && "number" === typeof m[f].y[1]) {
                                ...
                                b = P(b);
                                u && ca(this._eventManager.ghostCtx, p, k, l, v, b, 0, null, !1, !1, !1, !1);
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (var S = !0; g < r.length; g++)
                            if (t = r[g].x.getTime ? r[g].x.getTime() : r[g].x,
                            !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !S)))
                                if (null !== r[g].y && r[g].y.length && "number" === typeof r[g].y[0] && "number" === typeof r[g].y[1]) {
                                    ...
                                    q || S ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || C === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = D,
                                    ...
                                    g < r.length - 1 && (B !== (r[g].lineColor || F) || C !== (r[g].lineDashType || n.lineDashType)) && (d(),
                                    B = r[g].lineColor || F,
                                    k[k.length - 1].newStrokeStyle = B,
                                    b.strokeStyle = B,
                                    b.setLineDash && (r[g].lineDashType ? (C = r[g].lineDashType,
                                    k[k.length - 1].newLineDashArray = N(C, n.lineThickness),
                                    b.setLineDash(k[k.length - 1].newLineDashArray)) : (C = n.lineDashType,
                                    ...
                                    if (r[g].indexLabel || n.indexLabel || r[g].indexLabelFormatter || n.indexLabelFormatter)
                                        this._indexLabels.push({
                                            chartType: "rangeArea",
                                            dataPoint: r[g],
                                            dataSeries: n,
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < n.length) {
                        ...
                        for (g = !1; r < n.length; r++)
                            if (q = n[r].x.getTime ? n[r].x.getTime() : n[r].x,
                            !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g)))
                                if (null !== n[r].y && n[r].y.length && "number" === typeof n[r].y[0] && "number" === typeof n[r].y[1]) {
                                    ...
                                    r < n.length - 1 && (z !== (n[r].lineColor || x) || F !== (n[r].lineDashType || h.lineDashType)) && (z = n[r].lineColor || x,
                                    s[s.length - 1].newStrokeStyle = z,
                                    b.setLineDash && (n[r].lineDashType ? (F = n[r].lineDashType,
                                    s[s.length - 1].newLineDashArray = N(F, h.lineThickness)) : (F = h.lineDashType,
                                    ...
                                    if (n[r].indexLabel || h.indexLabel || n[r].indexLabelFormatter || h.indexLabelFormatter)
                                        this._indexLabels.push({
                                    ...
                                    0 < r && !g && (h.connectNullData ? b.setLineDash && (0 < s.length && (h.options.nullDataLineDashType || !n[r - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = C,
                                    F = h.nullDataLineDashType) : (d(B, x),
                                    s = [],
                                    y = [])),
                                    g = !0;
                        d(B, x);
        ...
        m.prototype.renderWaterfall = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = u ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, p = 0, l, k, h, n, r = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), p = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                this.dataPointMaxWidth && p > k && (p = Math.min(this.options.dataPointWidth ? this.dataPointWidth : Infinity, k));
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < v.length)
                        for (var z = 5 < q && s.bevelEnabled ? !0 : !1, F = !1, B = null, C = null, p = 0; p < v.length; p++)
                            if (v[p].getTime ? n = v[p].x.getTime() : n = v[p].x,
                            "number" !== typeof v[p].y) {
                                if (0 < p && !F && s.connectNullData)
                                    var y = s.options.nullDataLineDashType || !v[p - 1].lineDashType ? s.nullDataLineDashType : v[p - 1].lineDashType;
                                F = !0
                            } else {
                                ...
                                l = a.axisX.reversed ? l + a.plotType.totalDataSeries * q / 2 - (a.previousDataSeriesCount + g) * q << 0 : l - a.plotType.totalDataSeries * q / 2 + (a.previousDataSeriesCount + g) * q << 0;
                                ...
                                var R, S = l;
                                R = "undefined" !== typeof v[p].isIntermediateSum && !0 === v[p].isIntermediateSum || "undefined" !== typeof v[p].isCumulativeSum && !0 === v[p].isCumulativeSum ? 0 < v[p].y ? k : h : 0 < v[p].y ? h : k;
                                0 < p && B && (!F || s.connectNullData) && (F && c.setLineDash && c.setLineDash(N(y, t)),
                                c.beginPath(),
                                c.moveTo(B, C - x),
                                c.lineTo(S, R - x),
                                0 < t && c.stroke(),
        ...
        m.prototype.renderPie = function(a) {
            function d() {
                if (h && n) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                        ...
                        r = f.indexLabelFormatter ? f.indexLabelFormatter(m) : f.indexLabel ? k.replaceKeywordsWithValue(f.indexLabel, f, h, e) : h.indexLabelFormatter ? h.indexLabelFormatter(m) : h.indexLabel ? k.replaceKeywordsWithValue(h.indexLabel, f, h, e) : f.label ? f.label : "";
                        ...
                        l.indexLabelFontFamily = f.indexLabelFontFamily ? f.indexLabelFontFamily : h.indexLabelFontFamily;
                        ...
                        if (l.midAngle > Math.PI / 2 - t && l.midAngle < Math.PI / 2 + t) {
                            if (0 === a || g[c].midAngle > l.midAngle)
                                c = e;
                            a++
                        } else if (l.midAngle > 3 * Math.PI / 2 - t && l.midAngle < 3 * Math.PI / 2 + t) {
                            if (0 === b || g[d].midAngle > l.midAngle)
                                d = e;
                            b++
                        }
                    ...
                    for (e = 0; e < n.length; e++)
                        l = g[(c + e) % n.length],
                        1 < a && (l.midAngle > Math.PI / 2 - t && l.midAngle < Math.PI / 2 + t) && (f <= a / 2 && !r ? (l.hemisphere = "right",
                        f++) : (l.hemisphere = "left",
                        r = !0));
                    r = !1;
                    for (e = 0; e < n.length; e++)
                        l = g[(d + e) % n.length],
                        1 < b && (l.midAngle > 3 * Math.PI / 2 - t && l.midAngle < 3 * Math.PI / 2 + t) && (p <= b / 2 && !r ? (l.hemisphere = "left",
                        p++) : (l.hemisphere = "right",
                        r = !0))
                }
            }
            function c(a) {
                ...
                for (b = b = 0; b < n.length; b++)
                    ...
                    d = 0,
                    d = "left" === c.hemisphere ? "inside" !== h.indexLabelPlacement ? -(c.indexLabelTextBlock.width + r) : -c.indexLabelTextBlock.width / 2 : "inside" !== h.indexLabelPlacement ? r : -c.indexLabelTextBlock.width / 2,
                    c.indexLabelTextBlock.x += d,
                    c.indexLabelTextBlock.render(!0),
                    c.indexLabelTextBlock.x -= d,
                    c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2,
                    "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + C * Math.cos(c.midAngle),
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < n.length) {
                    var k = g[a];
                    if (0 > c && k.indexLabelTextBlock.y < l || 0 < c && k.indexLabelTextBlock.y > p)
                        return 0;
                    var q = 0
                      , r = 0
                      , r = q = q = 0;
                    ...
                    q = e(a);
                    p = l = 0;
                    0 > c ? (p = "right" === k.hemisphere ? r : q,
                    h = c,
                    null !== p && (r = -c,
                    c = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - (g[p].indexLabelTextBlock.y + g[p].indexLabelTextBlock.height / 2),
                    c - r < m && (l = -r,
                    p = f(p, l, d + 1),
                    +p.toFixed(x) > +l.toFixed(x) && (h = c > m ? -(c - m) : -(r - (p - l)))))) : 0 < c && (p = "right" === k.hemisphere ? q : r,
                    h = c,
                    null !== p && (r = c,
                    c = g[p].indexLabelTextBlock.y - g[p].indexLabelTextBlock.height / 2 - (k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2),
                    c - r < m && (l = r,
                    p = f(p, l, d + 1),
                    +p.toFixed(x) < +l.toFixed(x) && (h = c > m ? c - m : r - (l - p)))));
                    h && (d = k.indexLabelTextBlock.y + h,
                    c = 0,
                    c = "right" === k.hemisphere ? z.x + Math.sqrt(Math.pow(u, 2) - Math.pow(d - z.y, 2)) : z.x - Math.sqrt(Math.pow(u, 2) - Math.pow(d - z.y, 2)),
                    k.midAngle > Math.PI / 2 - t && k.midAngle < Math.PI / 2 + t ? (l = (a - 1 + g.length) % g.length,
                    l = g[l],
                    a = g[(a + 1 + g.length) % g.length],
                    "left" === k.hemisphere && "right" === l.hemisphere && c > l.indexLabelTextBlock.x ? c = l.indexLabelTextBlock.x - 15 : "right" === k.hemisphere && ("left" === a.hemisphere && c < a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x + 15)) : k.midAngle > 3 * Math.PI / 2 - t && k.midAngle < 3 * Math.PI / 2 + t && (l = (a - 1 + g.length) % g.length,
                    l = g[l],
                    a = g[(a + 1 + g.length) % g.length],
                    "right" === k.hemisphere && "left" === l.hemisphere && c < l.indexLabelTextBlock.x ? c = l.indexLabelTextBlock.x + 15 : "left" === k.hemisphere && ("right" === a.hemisphere && c > a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x - 15)),
            ...
            function p() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    if (h.radius || !h.radius && "undefined" !== typeof h.innerRadius && null !== h.innerRadius && C - d <= D)
                        l = !1;
                    l && (C -= d);
                    d = 0;
                            ...
                            if (null !== B) {
                                ...
                                if (0 > y) {
                                    for (var F = t = 0, J = 0; J < n.length; J++)
                                        J !== a && g[J].hemisphere === p.hemisphere && (g[J].indexLabelTextBlock.y < p.indexLabelTextBlock.y ? t++ : F++);
                                    t = y / (t + F || 1) * F;
                                    var F = -1 * (y - t)
                                      , I = J = 0;
                                    "right" === p.hemisphere ? (J = f(a, t),
                                    F = -1 * (y - J),
                                    I = f(B, F),
                                    +I.toFixed(x) < +F.toFixed(x) && +J.toFixed(x) <= +t.toFixed(x) && f(a, -(F - I))) : (J = f(B, t),
                                    F = -1 * (y - J),
                                    I = f(a, F),
                                    +I.toFixed(x) < +F.toFixed(x) && +J.toFixed(x) <= +t.toFixed(x) && f(B, -(F - I)))
                                }
                            }
                        }
                    } else
                    ...
                    for (a = 0; a < n.length; a++)
                        ...
                        0 !== B.height && 0 !== B.width)
                            B = B = 0,
                            "right" === p.hemisphere ? (B = q.x2 - (p.indexLabelTextBlock.x + p.indexLabelTextBlock.width + r),
                            B *= -1) : B = q.x1 - (p.indexLabelTextBlock.x - p.indexLabelTextBlock.width - r),
                            0 < B && (!l && p.indexLabelText && (t = "right" === p.hemisphere ? q.x2 - p.indexLabelTextBlock.x : p.indexLabelTextBlock.x - q.x1,
                            0.3 * p.indexLabelTextBlock.maxWidth > t ? p.indexLabelText = "" : p.indexLabelTextBlock.maxWidth = 0.85 * t,
                            0.3 * p.indexLabelTextBlock.maxWidth < t && (p.indexLabelTextBlock.x -= "right" === p.hemisphere ? 2 : -2)),
                            Math.abs(p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - z.y) < C || Math.abs(p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 - z.y) < C) && (B /= Math.abs(Math.cos(p.indexLabelAngle)),
                            9 < B && (B *= 0.3),
                            B > d && (d = B)),
                            B = B = 0,
                            0 < p.indexLabelAngle && p.indexLabelAngle < Math.PI ? (B = q.y2 - (p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 + 5),
                            B *= -1) : B = q.y1 - (p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 - 5),
                            0 < B && (!l && p.indexLabelText && (t = 0 < p.indexLabelAngle && p.indexLabelAngle < Math.PI ? -1 : 1,
                            0 === f(a, B * t) && f(a, 2 * t)),
                            Math.abs(p.indexLabelTextBlock.x - z.x) < C && (B /= Math.abs(Math.sin(p.indexLabelAngle)),
                            9 < B && (B *= 0.3),
                            B > d && (d = B)));
                            ...
                            s.indexLabelText) {
                                ...
                                if (null !== p) {
                                    ...
                                    if (k = 0 > y) {
                                        ...
                                        k = s.indexLabelTextBlock.x + s.indexLabelTextBlock.width < l.indexLabelTextBlock.x - r || k > w + r || q > A + r || m < t - r ? !1 : !0
                                    }
                                    k ? (0 > a && (a = h),
                                    p !== a && (c = p,
                                    d += -y),
                                    0 === h % Math.max(n.length / 10, 3) && (f = !0)) : f = !0;
            ...
            var k = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var h = this.data[a.dataSeriesIndexes[0]], n = h.dataPoints, r = 10, q = this.plotArea, g = h.dataPointEOs, m = 2, u, v = 1.3, t = 20 / 180 * Math.PI, x = 6, z = {
                    x: (q.x2 + q.x1) / 2,
                    y: (q.y2 + q.y1) / 2
                }, y = 0;
                a = !1;
                for (var B = 0; B < n.length; B++)
                    y += Math.abs(n[B].y),
                    !a && ("undefined" !== typeof n[B].indexLabel && null !== n[B].indexLabel && 0 < n[B].indexLabel.toString().length) && (a = !0),
                    !a && ("undefined" !== typeof n[B].label && null !== n[B].label && 0 < n[B].label.toString().length) && (a = !0);
                if (0 !== y) {
        ...
        m.prototype.renderFunnel = function(a) {
            ...
            function c() {
                ...
                if (0 === g)
                    return -1;
                for (var p = d[0] = 0, l = 0, k, n, b = b - a, p = !1, h = 0; h < x.length; h++)
                    a = Math.abs(x[h].y) * f / g,
                    p ? k = 0 == Number(c.toFixed(3)) ? 0 : a / c : (n = aa * aa * b * b - 4 * Math.abs(aa) * a,
                    0 > n ? (n = c,
                    p = (b + n) * (e - l) / 2,
                    a -= p,
                    k = e - l,
                    ...
                    k += 0 == n ? 0 : a / n,
                    l += a / n,
                    p = !0) : (k = (Math.abs(aa) * b - Math.sqrt(n)) / 2,
                    n = b - 2 * k / Math.abs(aa),
                    l += k,
                    l > e && (l -= k,
                    n = c,
            ...
            function b() {
                if (t && x) {
                    for (var a, b, c, d, e, f, h, l, p, k, n, q, r, m, w = [], A = [], v = {
                        ...
                        w[z] = M - m - V;
                    m = 0.5 * V;
                    for (var z = 0, C = x.length - 1; z < x.length || 0 <= C; z++,
                    C--) {
                        ...
                        "inside" === t.indexLabelPlacement && (w[z] = z !== ca ? t.reversed ? O[z].x2 - O[z].x1 : O[z].x3 - O[z].x4 : O[z].x3 - O[z].x6,
                        20 > w[z] && (w[z] = z !== ca ? t.reversed ? O[z].x3 - O[z].x4 : O[z].x2 - O[z].x1 : O[z].x2 - O[z].x1,
                        w[z] /= 2));
            ...
            function e() {
                ...
                e = !1;
                c = 0;
                for (var g, h = M - $ - V / 2, h = t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth > h ? h : t.indexLabelMaxWidth : h, l = H.length - 1; 0 <= l; l--) {
                    g = x[H[l].id];
                    c = H[l];
                    d = c.textBlock;
                ...
                if (e)
                    for (l = H.length - 1; 0 <= l; l--)
                        ...
                        t.reversed ? (H[l].textBlock.y + H[l].height > T + F && (H[l].textBlock.y = T + F - H[l].height),
                        H[l].textBlock.y < ra - F && (H[l].textBlock.y = ra - F)) : (H[l].textBlock.y < T - F && (H[l].textBlock.y = T - F),
                        H[l].textBlock.y + H[l].height > ra + F && (H[l].textBlock.y = ra + F - H[l].height))
            }
            function f() {
                var a, b, c, d;
                if ("inside" !== t.indexLabelPlacement)
                    for (var e = 0; e < O.length; e++)
                        0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = O[e],
                        c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2,
                        b = t.reversed ? "undefined" !== typeof a.x5 ? c > wa ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < wa ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1,
                        H[e].textBlock.x = b + V,
                        H[e].textBlock.y = c - H[e].height / 2,
                        t.reversed ? (H[e].textBlock.y + H[e].height > T + F && (H[e].textBlock.y = T + F - H[e].height),
                        H[e].textBlock.y < ra - F && (H[e].textBlock.y = ra - F)) : (H[e].textBlock.y < T - F && (H[e].textBlock.y = T - F),
                        H[e].textBlock.y + H[e].height > ra + F && (H[e].textBlock.y = ra + F - H[e].height)));
                else
            ...
            function p() {
                ...
                function b() {
                    ...
                    for (var l, p = 1; p < h; p++) {
                        ...
                        for (var n = H.length - 1; 0 <= n; n--)
                            !H[n].isDirty && (H[n].textBlock.y < e && H[n].textBlock.y + H[n].height > e) && (l = q(n),
                            !(l >= H.length - 1) && H[n].textBlock.y + H[n].height + da > H[l].textBlock.y && (H[n].textBlock.y = H[n].textBlock.y + H[n].height - e > e - H[n].textBlock.y ? e + 1 : e - H[n].height - 1))
                    }
                ...
                for (var d, e, f, g, h, p, k = 1, n = 0; n < 2 * k; n++) {
                    for (var m = H.length - 1; 0 <= m && !(0 <= r(m) && r(m),
                    f = H[m],
                    g = f.textBlock,
                    p = (h = q(m) < O.length ? H[q(m)] : null) ? h.textBlock : null,
                    d = +f.height.toFixed(6),
                    e = +g.y.toFixed(6),
                    !f.isDirty && (h && e + d + da > +p.y.toFixed(6)) && (d = g.y + d + da - p.y,
                    e = a(m, -d),
                    e < d && (0 < e && (d -= e),
                    e = a(q(m), d),
                    e != d))); m--)
            ...
            function l(a, b) {
                return (b < O.length ? H[b].textBlock.y : t.reversed ? T + F : ra + F) - (0 > a ? t.reversed ? ra - F : T - F : H[a].textBlock.y + H[a].height + da)
            }
            function k(a, b, c) {
                var d, e, g, l = [], p = F, r = [];
            ...
            var y = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var t = this.data[a.dataSeriesIndexes[0]], x = t.dataPoints, z = this.plotArea, F = 0.025 * z.width, B = 0.01 * z.width, C = 0, D = z.height - 2 * F, E = Math.min(z.width - 2 * B, 2.8 * z.height), I = !1, R = 0; R < x.length; R++)
                    if (!I && ("undefined" !== typeof x[R].indexLabel && null !== x[R].indexLabel && 0 < x[R].indexLabel.toString().length) && (I = !0),
                    !I && ("undefined" !== typeof x[R].label && null !== x[R].label && 0 < x[R].label.toString().length) && (I = !0),
                    !I && "function" === typeof t.indexLabelFormatter || "function" === typeof x[R].indexLabelFormatter)
                        I = !0;
                ...
                if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                    ...
                    "string" === typeof ba && ba.match(/%$/) ? (ba = parseInt(ba),
                    ba = ba * D / 100) : ba = parseInt(ba),
                    "string" === typeof G && G.match(/%$/) ? (G = parseInt(G),
                    G = G * a / 100) : G = parseInt(G),
                    ba > D ? ba = D : 0 >= ba && (ba = 0),
                    G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === t.type && (G = ba = 0,
                    ...
                    var B = R + a / 2
                      ...
                      , ra = t.reversed ? Z : Q;
                    a = [];
                    var B = [], O = [], E = [], U = Z, ca, aa = (wa - T) / (K - W), ea = -aa, R = "area" === (t.valueRepresents ? t.valueRepresents : "height") ? c() : d();
                    if (-1 !== R) {
                        if (t.reversed)
                            for (E.push(U),
                            G = R.length - 1; 0 < G; G--)
                        ...
                        if (t.reversed)
                            for (G = 0; G < R.length; G++)
                                E[G] < wa ? (a.push(K),
                                B.push(X),
                                ca = G) : (a.push((E[G] - T + aa * W) / aa),
                                B.push((E[G] - T + ea * $) / ea));
                        else
                            for (G = 0; G < R.length; G++)
                                E[G] < wa ? (a.push((E[G] - T + aa * W) / aa),
                                B.push((E[G] - T + ea * $) / ea),
                                ca = G) : (a.push(K),
                                B.push(X));
                        ...
                        for (G = 0; G < x.length; G++)
                            x[G].exploded && (R = !0,
                            t.reversed ? Y.push(x.length - 1 - G) : Y.push(G));
                        ...
                        for (G = 0; G < O.length; G++)
                            C = O[G],
                            pa(P, C, t.fillOpacity),
                            ga.push(C.y1);
                        v(P);
                        I && t.visible && ("inside" === t.indexLabelPlacement || y.animationEnabled || n(P),
                        ...
                        this.funnelPyramidClickHandler = function(a) {
                            var b = -1;
                            if (!ha && !y.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = t.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex,
                            0 <= b)) {
                                a = b;
        ...
        m.prototype.exportChart = function(a) {
            ...
            if (b && d && c) {
                ...
                if ("undefined" !== typeof Blob && new Blob) {
                    for (var p = b.replace(/^data:[a-z\/]*;base64,/, ""), p = atob(p), l = new ArrayBuffer(p.length), l = new Uint8Array(l), k = 0; k < p.length; k++)
                        l[k] = p.charCodeAt(k);
                    d = new Blob([l.buffer],{
                        type: "image/" + d
                    });
        ...
        m.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                try {
                    var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                    g && 0 < g.length && (h = Ea(g[2]),
                    a = Ea(g[1]))
                } catch (l) {}
                g = null;
                if ("color" === a)
                    return "waterfall" === c.type ? d.color ? d.color : 0 < d.y ? c.risingColor : c.fallingColor : "error" === c.type ? c.color ? c.color : c._colorSet[h % c._colorSet.length] : d.color ? d.color : c.color ? c.color : c._colorSet[b % c._colorSet.length];
                ...
                if ("x" === a)
                    if ("dateTime" === c.axisX.valueType || "dateTime" === c.xValueType || d.x && d.x.getTime) {
                        ...
                        return ea(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", f._cultureInfo);
                else
        ...
        E.prototype.setLayout = function() {
            ...
            p = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height) : "center" === this.verticalAlign && (this.orientation = "vertical",
                ...
                if (r.dataPoints && r.dataPoints.length)
                    if ("pie" !== r.type && "doughnut" !== r.type && "funnel" !== r.type && "pyramid" !== r.type) {
                        var q = r.legendMarkerType = r.legendMarkerType ? r.legendMarkerType : "line" !== r.type && "stepLine" !== r.type && "spline" !== r.type && "scatter" !== r.type && "bubble" !== r.type || !r.markerType ? "error" === r.type && r._linkedSeries ? r._linkedSeries.legendMarkerType ? r._linkedSeries.legendMarkerType : I.getDefaultLegendMarker(r._linkedSeries.type) : I.getDefaultLegendMarker(r.type) : r.markerType
                          , g = r.legendText ? r.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                            chart: this.chart,
                            legend: this.options,
                            dataSeries: r,
                            dataPoint: null
                          ...
                          , t = r.legendMarkerBorderThickness ? r.legendMarkerBorderThickness : r.markerBorderThickness ? Math.max(1, Math.round(0.2 * u)) : 0;
                        ...
                        for (var x = 0; x < r.dataPoints.length; x++) {
                            var z = r.dataPoints[x]
                              , q = z.legendMarkerType ? z.legendMarkerType : r.legendMarkerType ? r.legendMarkerType : I.getDefaultLegendMarker(r.type)
                              ...
                              , v = z.legendMarkerBorderColor ? z.legendMarkerBorderColor : r.legendMarkerBorderColor ? r.legendMarkerBorderColor : z.markerBorderColor ? z.markerBorderColor : r.markerBorderColor
                            ...
                            (z.showInLegend || r.showInLegend && !1 !== z.showInLegend) && k.push(q)
                        }
            }
                ...
                for (n = 0; n < k.length; n++) {
                    ...
                    if (!(0 >= p || "undefined" === typeof p || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (u + l + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)));
                            if (!r || r.width + Math.round(q.textBlock.width + u + l + (0 === r.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f)
                                r = {
                                    items: [],
                                    width: 0
                                },
                            ...
                            q.textBlock.measureText(),
                            null !== this.itemWidth && (q.textBlock.width = this.itemWidth - (u + l + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0))),
                            this.height < p - this.lineHeight ? (r = {
                                items: [],
                                width: 0
                            },
                            h.push(r)) : (r = h[x],
                        ...
                        q.textBlock.y = 0;
                        r.width += Math.round(q.textBlock.width + u + l + (0 === r.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0));
                        r.items.push(q);
        ...
        E.prototype.render = function() {
            ...
            for (var l = 0, k = 0; k < p.length; k++) {
                for (var h = p[k], n = 0, r = 0; r < h.items.length; r++) {
                    ...
                    X.drawMarker(g + f / 2, m + this.lineHeight / 2, this.ctx, q.markerType, "error" === q.chartType || "line" === q.chartType || "spline" === q.chartType ? q.markerSize / 2 : q.markerSize, q.markerColor, q.markerBorderColor, q.markerBorderThickness);
                    q.textBlock.x = g + c + f;
                    if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType)
            ...
            for (; ; ) {
                ...
                if (0 <= f && f < this.dataPoints.length) {
                    var b = this.dataPoints[f]
                      , r = this.axisX.logarithmic ? b.x > a ? b.x / a : a / b.x : Math.abs(b.x - a);
                    r < c.distance && (c.dataPoint = b,
                    c.distance = r,
                    c.index = f);
                    b = r;
                    b <= l ? l = b : 0 < p ? k++ : h++;
        ...
        I.prototype.getDataPointAtXY = function(a, d, c) {
            ...
            if ("none" !== this.chart.plotInfo.axisPlacement)
                ...
                this.axisX.logarithmic)
                    ...
                    r = 0 < q ? Math.min(Math.max((this.dataPoints.length - 1) / q * (r - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
            for (; ; ) {
                f = 0 < p ? r + e : r - e;
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (q) {
                        ...
                        case "doughnut":
                            ...
                            m < q.radius && m > u && (m = Math.atan2(d - s.y, a - s.x),
                            0 > m && (m += 2 * Math.PI),
                        ...
                        case "pyramid":
                            m = q.funnelSection;
                            d > m.y1 && d < m.y4 && (m.y6 ? d > m.y6 ? (f = m.x6 + (m.x5 - m.x6) / (m.y5 - m.y6) * (d - m.y6),
                            m = m.x3 + (m.x4 - m.x3) / (m.y4 - m.y3) * (d - m.y3)) : (f = m.x1 + (m.x6 - m.x1) / (m.y6 - m.y1) * (d - m.y1),
                            m = m.x2 + (m.x3 - m.x2) / (m.y3 - m.y2) * (d - m.y2)) : (f = m.x1 + (m.x4 - m.x1) / (m.y4 - m.y1) * (d - m.y1),
        ...
        D.prototype.createLabels = function() {
            var a, d, c = 0, b = 0, e, f = 0, p = 0, b = 0, b = this.interval, l = 0, k, h = 0.6 * this.chart.height, n;
            a = !1;
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                e = Ua(new Date(this.viewportMaximum), this.interval, this.intervalType),
                g = q,
                c = this.intervalStartPosition; c < e; Ua(c, b, this.intervalType)) {
            ...
            if ("bottom" === this._position || "top" === this._position)
                ...
                l = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) * Q[this.intervalType + "Duration"] * this.interval,
                        ...
                        for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b),
                                    n = (h - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)),
                                    !s(this.options.labelWrap))
                                        ...
                                        this.sessionVariables.labelWrap = this.labelWrap,
                                        d && m.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap,
                                        ...
                                        this.sessionVariables.labelMaxHeight = p,
                                        this.sessionVariables.labelMaxWidth = f,
                                        d && m.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25,
                                        ...
                                        if (s(this.options.labelWrap))
                                            if (!s(this.options.labelMaxWidth))
                                                ...
                                                q < f)
                                                    ...
                                                    this.sessionVariables.labelMaxHeight = p,
                                                    this.sessionVariables.labelAngle = this.labelAngle));
                                                else if (v === c && (0 === v && q + this._labels[v + 1].textBlock.measureText().width - 2 * f > r || v === this._labels.length - 1 && q + this._labels[v - 1].textBlock.measureText().width - 2 * f > r || 0 < v && v < this._labels.length - 1 && q + this._labels[v + 1].textBlock.measureText().width - 2 * f > r && q + this._labels[v - 1].textBlock.measureText().width - 2 * f > r))
                                                    r = 0 === v ? q + this._labels[v + 1].textBlock.measureText().width - 2 * f : q + this._labels[v - 1].textBlock.measureText().width - 2 * f,
                                                    this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? g : this.options.labelFontSize,
                                                    this.sessionVariables.labelWrap = !0,
                                                    this.sessionVariables.labelAngle = -25,
                                                    this.sessionVariables.labelMaxWidth = n;
                                                    ...
                                                    b = 0; b < this._labels.length; b++)
                                                        ...
                                                        d = d.measureText(),
                                                        m.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
                                    }
                                else
                                    (this.sessionVariables.labelAngle = this.labelAngle,
                                    this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b),
                                    n = 0 != this.labelAngle ? (h - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) : f,
                                    this.sessionVariables.labelMaxHeight = p = this.labelWrap ? (h - n * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) : 1.5 * this.labelFontSize,
                                    ...
                                    this.sessionVariables.labelMaxHeight = p) : (this.sessionVariables.labelAngle = this.labelAngle,
                                    this.sessionVariables.labelMaxWidth = n,
                                    this.sessionVariables.labelMaxHeight = b < 0.9 * l ? 0.9 * l : b,
                    ...
                    !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
                                Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
                                s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle ? s(this.options.labelWrap) ? s(this.options.labelWrap) && (s(this.options.labelMaxWidth) ? s(d) || (l = m.height + d.height >> 0,
                                l - 2 * p > q && (q = l - 2 * p,
                                l >= 2 * p && l < 2.4 * p ? (s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelMaxHeight = p,
                                this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize) : l >= 2.4 * p && l < 2.8 * p ? (this.sessionVariables.labelMaxHeight = b,
                                this.sessionVariables.labelFontSize = this.labelFontSize,
                                this.sessionVariables.labelWrap = !0) : l >= 2.8 * p && l < 3.2 * p ? (this.sessionVariables.labelMaxHeight = p,
                                this.sessionVariables.labelWrap = !0,
                                s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelAngle = s(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : l >= 3.2 * p && l < 3.6 * p ? (this.sessionVariables.labelMaxHeight = b,
                                this.sessionVariables.labelWrap = !0,
                                this.sessionVariables.labelFontSize = this.labelFontSize) : l > 3.6 * p && l < 10 * p ? (s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelMaxWidth = f,
                                this.sessionVariables.labelMaxHeight = p,
                                this.sessionVariables.labelAngle = s(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : l > 10 * p && l < 50 * p && (s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelMaxHeight = p,
                                this.sessionVariables.labelMaxWidth = f,
                                this.sessionVariables.labelAngle = s(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = p,
                                this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth)) : (this.sessionVariables.labelMaxWidth = this.labelWrap ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : this.labelMaxWidth ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : f,
                                this.sessionVariables.labelMaxHeight = p) : (this.sessionVariables.labelAngle = this.labelAngle,
                                this.sessionVariables.labelMaxWidth = 0 === this.labelAngle ? f : Math.min((b - p * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), p),
                                ...
                                this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : b,
                                s(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this.options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : b,
                                this.sessionVariables.labelWrap = this.labelWrap,
                                this.sessionVariables.labelMaxWidth = f) : (this.sessionVariables.labelMaxHeight = p,
            ...
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    if ("bottom" === this._position || "top" === this._position)
                        y = s(f.options.labelWrap) ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                    if ("left" === this._position || "right" === this._position)
                        y = s(f.options.labelWrap) ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
        ...
        D.setLayout = function(a, d, c, b, e, f) {
            var p, l, k, h, n = a[0] ? a[0].chart : d[0].chart, r = n.isNavigator ? 0 : 10, q = n._axes;
            if (a && 0 < a.length)
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
                    for (var m = q[g].scaleBreaks._appliedBreaks, u = 0; u < m.length && !(m[u].startValue > q[g].viewportMaximum); u++)
                        m[u].endValue < q[g].viewportMinimum || (s(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = u),
                        m[u].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = u));
            for (var v = u = 0, t = 0, x = 0, z = 0, y = 0, B = 0, C, D, E = l = 0, I, J, L, m = I = J = L = !1, g = 0; g < q.length; g++)
            ...
            if ("normal" === e) {
                for (var x = [], z = [], y = [], B = [], M = [], N = [], P = [], Q = []; 4 > u; ) {
                    ...
                    if (c && 0 < c.length)
                        for (y = [],
                        g = O = 0; g < c.length; g++)
                            y.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)),
                            O += y[g],
                    ...
                    if (b && 0 < b.length)
                        for (B = [],
                        g = aa = 0; g < b.length; g++)
                            B.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)),
                            aa += B[g],
                            $ += b[g] ? b[g].margin : 0;
                    else
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++)
                            a[g] && (a[g].lineCoordinates.x1 = p,
                            k = Math.round(f.x2 - aa - $ > n.width - r ? n.width - r : f.x2 - aa - $),
                            a[g]._labels && 1 < a[g]._labels.length && (l = h = 0,
                            h = a[g]._labels[1],
                            l = "dateTime" === a[g].valueType ? a[g]._labels[a[g]._labels.length - 2] : a[g]._labels[a[g]._labels.length - 1],
                            v = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)),
                            ...
                            !a[g] || (!a[g].labelAutoFit || s(C) || s(D) || n.isNavigator || n.stockChart) || (l = 0,
                            0 < a[g].labelAngle ? D + t > k && (l += 0 < a[g].labelAngle ? D + t - k - aa : 0) : 0 > a[g].labelAngle ? C - v < p && C - v < a[g].viewportMinimum && (E = p - (K + a[g].tickLength + y + C - v + a[g].labelFontSize / 2)) : 0 === a[g].labelAngle && (D + t > k && (l = D + t / 2 - k - aa),
                            C - v < p && C - v < a[g].viewportMinimum && (E = p - K - a[g].tickLength - y - C + v / 2)),
                            a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < l ? k -= l : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 > a[g].labelAngle && 0 < E ? p += E : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < E && (p += E),
                            0 < l && (k -= l))),
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            ...
                            d[g].lineCoordinates.x2 = Math.round(f.x2 - aa - $ > n.width - r ? n.width - r : f.x2 - aa - $),
                            d[g].lineCoordinates.width = Math.abs(k - p),
                            d[g]._labels && 1 < d[g]._labels.length && (h = d[g]._labels[1],
                            l = "dateTime" === d[g].valueType ? d[g]._labels[d[g]._labels.length - 2] : d[g]._labels[d[g]._labels.length - 1],
                            v = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)),
                            t = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle))),
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            ...
                            c[g] && (p = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1),
                            K = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : r,
                            l = Math.round(f.y1 + X + Y < Math.max(K, r) ? Math.max(K, r) : f.y1 + X + Y),
                            k = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1),
                            K = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : r,
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] && (p = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2),
                            k = Math.round(p),
                            ...
                            "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (B[g] - b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2,
                    ...
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++)
                            ...
                            a[g]._labels && 1 < a[g]._labels.length && (C = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1,
                            p = a[g]._labels[a[g]._labels.length - ("dateTime" === a[g].valueType ? 2 : 1)].position,
                            p = a[g].getApparentDifference(a[g].viewportMinimum, p),
                            D = a[g].logarithmic ? (1 < p ? Math.log(p) / a[g].conversionParameters.lnLogarithmBase * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1 : (0 < p ? p * Math.abs(a[g].conversionParameters.pixelPerUnit) : 0) + a[g].lineCoordinates.x1));
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            d[g].calculateValueToPixelConversionParameters(),
                            d[g].calculateBreaksSizeInValues(),
                            d[g]._labels && 1 < d[g]._labels.length && (C = (d[g].logarithmic ? Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1,
                            p = d[g]._labels[d[g]._labels.length - ("dateTime" === d[g].valueType ? 2 : 1)].position,
                            p = d[g].getApparentDifference(d[g].viewportMinimum, p),
                            D = d[g].logarithmic ? (1 < p ? Math.log(p) / d[g].conversionParameters.lnLogarithmBase * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1 : (0 < p ? p * Math.abs(d[g].conversionParameters.pixelPerUnit) : 0) + d[g].lineCoordinates.x1);
                    for (g = 0; g < q.length; g++)
                ...
                for (N = []; 4 > u; ) {
                    ...
                    if (a && 0 < a.length)
                        for (E = [],
                        g = W = 0; g < a.length; g++)
                            E.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)),
                            W += E[g],
                            e += a[g] && !n.isNavigator ? a[g].margin : 0;
                    else
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            ...
                            k = Math.round(f.x2 - U - Y > n.width - 10 ? n.width - 10 : f.x2 - U - Y),
                            c[g].labelAutoFit && !s(x) && (0 < !a.length && (p = 0 > c[g].labelAngle ? Math.max(p, x) : 0 === c[g].labelAngle ? Math.max(p, x / 2) : p),
                            0 < !d.length && (k = 0 < c[g].labelAngle ? k - z / 2 : 0 === c[g].labelAngle ? k - z / 2 : k)),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g].lineCoordinates = {},
                            p = Math.round(f.x1 + W + e),
                            k = Math.round(f.x2 - U - Y > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - U - Y),
                            b[g] && b[g].labelAutoFit && !s(y) && (0 < !a.length && (p = 0 < b[g].labelAngle ? Math.max(p, y) : 0 === b[g].labelAngle ? Math.max(p, y / 2) : p),
                            0 < !d.length && (k -= B / 2)),
                    ...
                    if (c && 0 < c.length)
                        for (r = [],
                        g = T = 0; g < c.length; g++)
                            r.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)),
                            T += r[g] + c[g].margin,
                            K += c[g].margin;
                    else
                    ...
                    if (b && 0 < b.length)
                        for (C = [],
                        g = V = 0; g < b.length; g++)
                            C.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)),
                            V += C[g],
                            $ += b[g].margin;
                    else
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            0 < c[g]._labels.length && (h = c[g]._labels[0],
                            l = c[g]._labels[c[g]._labels.length - 1],
                            x = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)),
                            z = l.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(l.textBlock.angle)) + (l.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(l.textBlock.angle)));
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] && 0 < b[g]._labels.length && (h = b[g]._labels[0],
                            l = b[g]._labels[b[g]._labels.length - 1],
                            y = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)),
                    ...
                    if (n.panEnabled)
                        for (g = 0; g < c.length; g++)
                            r[g] = s(n.sessionVariables.axisY.height) ? n.sessionVariables.axisY.height = r[g] : n.sessionVariables.axisY.height;
                    else
                        for (g = 0; g < c.length; g++)
                    ...
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--)
                            ...
                            "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + r[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" === c[g].tickPlacement ? c[g].tickLength : 0),
                    ...
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--)
                            b[g] && (l = Math.round(f.y1),
                            h = Math.round(f.y1 + (C[g] + b[g].margin + G)),
                            b[g].lineCoordinates.y1 = h,
                            b[g].lineCoordinates.y2 = h,
                            "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - C[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)),
                            b[g].bounds = {
                                x1: p,
                                y1: l + (b[g].margin + G),
                                x2: k,
                        ...
                        for (g = 0; g < a.length; g++) {
                            ...
                            if (c && 0 < c.length)
                                for (K = 0; K < c.length; K++)
                                    ...
                                    p = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - W : p);
                            if (b && 0 < b.length)
                            ...
                            "inside" === a[g].labelPlacement && 0 < g && (a[g].lineCoordinates.x1 = a[g].lineCoordinates.x1 - (E[g] - (a[g]._titleTextBlock ? a[g]._titleTextBlock.height : 0)) + ("outside" === a[g].tickPlacement ? a[g].tickLength : 0),
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            if (c && 0 < c.length)
                                for (K = 0; K < c.length; K++)
                                    c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k,
                                    p = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - U : p);
                            if (b && 0 < b.length)
                                for (K = 0; K < b.length; K++)
                            ...
                            "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.x1 = d[g].lineCoordinates.x1 + (v[g] - (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0) - 2) - ("outside" === d[g].tickPlacement ? d[g].tickLength : 0),
        ...
        D.prototype.calculateBreaksSizeInValues = function() {
            for (var a = "left" === this._position || "right" === this._position ? this.lineCoordinates.height || this.chart.height : this.lineCoordinates.width || this.chart.width, d = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = this.conversionParameters.pixelPerUnit || a / (this.logarithmic ? this.conversionParameters.maximum / this.conversionParameters.minimum : this.conversionParameters.maximum - this.conversionParameters.minimum), b = this.scaleBreaks && !s(this.scaleBreaks.options.spacing), e, f = 0; f < d.length; f++)
                ...
                d[f].spacing = Qa(d[f].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0,
        ...
        D.prototype.renderLabelsTicksAndTitle = function() {
                ...
                if ("bottom" === this._position || "top" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, k, l = this.viewportMaximum, m = this.lineCoordinates.width / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) {
                            r = this._labels[h];
                            if (r.position < this.viewportMinimum)
                                break;
                            r.position > this.viewportMaximum || !(h === this._labels.length - 1 || k < Math.log(l / r.position) * m / e) || (c.push(r),
                            l = r.position,
                            k = r.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + r.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = c
                    } else {
                        for (h = 0; h < this._labels.length; h++)
                            r = this._labels[h],
                            r.position < this.viewportMinimum || (k = r.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + r.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                            c += k);
                ...
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], n, l = this.viewportMaximum, m = this.lineCoordinates.height / Math.log(this.range), h = this._labels.length - 1; 0 <= h; h--) {
                            ...
                            if (r.position < this.viewportMinimum)
                                break;
                            r.position > this.viewportMaximum || !(h === this._labels.length - 1 || n < Math.log(l / r.position) * m) || (c.push(r),
                            l = r.position,
                            n = r.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + r.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = c
                    } else {
                        for (h = 0; h < this._labels.length; h++)
                            r = this._labels[h],
                            r.position < this.viewportMinimum || (n = r.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + r.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                            b += n);
            ...
            if ("bottom" === this._position) {
                for (h = 0; h < this._labels.length; h++)
                    r = this._labels[h],
                    r.position < this.viewportMinimum || r.position > this.viewportMaximum || (q = this.getPixelCoordinatesOnAxis(r.position),
                    ...
                    this.ctx.stroke()),
                    d && 0 !== f++ % 2 && this.labelAutoFit || (0 === r.textBlock.angle ? (q.x -= r.textBlock.width / 2,
                    q.y = "inside" === this.labelPlacement ? q.y - (("inside" === this.tickPlacement ? this.tickLength : 0) + r.textBlock.height - r.textBlock.fontSize / 2) : q.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + r.textBlock.fontSize / 2 + 5) : (q.x = "inside" === this.labelPlacement ? 0 > this.labelAngle ? q.x : q.x - r.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : q.x - (0 > this.labelAngle ? r.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0),
                    q.y = "inside" === this.labelPlacement ? 0 > this.labelAngle ? q.y - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : q.y - ("inside" === this.tickPlacement ? 0 : this.tickLength) - Math.abs(r.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + 5) : q.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + Math.abs(0 > this.labelAngle ? r.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)),
                    r.textBlock.x = q.x,
                    r.textBlock.y = q.y));
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (h = 0; h < a._labels.length; h++)
                        if (r = a._labels[h],
                        !(r.position < a.viewportMinimum || r.position > a.viewportMaximum) && (q = a.getPixelCoordinatesOnAxis(r.position),
                        a.tickThickness)) {
                ...
                for (h = 0; h < this._labels.length; h++)
                    ...
                    this.ctx.stroke()),
                    d && 0 !== f++ % 2 && this.labelAutoFit || (0 === r.textBlock.angle ? (q.x -= r.textBlock.width / 2,
                    q.y = "inside" === this.labelPlacement ? q.y + this.labelFontSize / 2 + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + r.textBlock.height - r.textBlock.fontSize / 2)) : (q.x = "inside" === this.labelPlacement ? 0 < this.labelAngle ? q.x : q.x - r.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : q.x + (r.textBlock.height - this.labelFontSize) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? r.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0),
                    q.y = "inside" === this.labelPlacement ? 0 < this.labelAngle ? q.y + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - r.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + ((r.textBlock.height - r.textBlock.fontSize / 2) * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? r.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))),
                    r.textBlock.x = q.x,
                    r.textBlock.y = q.y));
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (h = 0; h < a._labels.length; h++)
                ...
                for (h = 0; h < this._labels.length; h++)
                    ...
                    this.ctx.stroke()),
                    d && 0 !== f++ % 2 && this.labelAutoFit || (0 === this.labelAngle ? (r.textBlock.y = q.y,
                    r.textBlock.x = "inside" === this.labelPlacement ? q.x + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : q.x - r.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength) - 5) : (r.textBlock.y = "inside" === this.labelPlacement ? q.y : q.y - r.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle),
                    r.textBlock.x = "inside" === this.labelPlacement ? q.x + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : 0 < this.labelAngle ? q.x - r.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength) - 5 : q.x - r.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) + (r.textBlock.height - r.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength))));
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (h = 0; h < a._labels.length; h++)
                        if (r = a._labels[h],
                        !(r.position < a.viewportMinimum || r.position > a.viewportMaximum) && (q = a.getPixelCoordinatesOnAxis(r.position),
                ...
                for (h = 0; h < this._labels.length; h++)
                    ...
                    this.ctx.stroke()),
                    d && 0 !== f++ % 2 && this.labelAutoFit || (0 === this.labelAngle ? (r.textBlock.y = q.y,
                    r.textBlock.x = "inside" === this.labelPlacement ? q.x - r.textBlock.width - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : q.x + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5) : (r.textBlock.y = "inside" === this.labelPlacement ? q.y - r.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0 > this.labelAngle ? q.y : q.y - (r.textBlock.height - r.textBlock.fontSize / 2 - 5) * Math.cos(Math.PI / 180 * this.labelAngle),
                    r.textBlock.x = "inside" === this.labelPlacement ? q.x - r.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : 0 < this.labelAngle ? q.x + (r.textBlock.height - r.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) + ("inside" === this.tickPlacement ? 0 : this.tickLength) : q.x + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5)));
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (h = 0; h < a._labels.length; h++)
                        if (r = a._labels[h],
                        !(r.position < a.viewportMinimum || r.position > a.viewportMaximum) && (q = a.getPixelCoordinatesOnAxis(r.position),
            ...
            if ("inside" === this.labelPlacement)
                this.chart.addEventListener("dataAnimationEnd", function() {
                    for (h = 0; h < a._labels.length; h++)
                        r = a._labels[h],
                        r.position < a.viewportMinimum || (r.position > a.viewportMaximum || d && 0 !== f++ % 2 && a.labelAutoFit) || (a.ctx.save(),
                        a.ctx.beginPath(),
        ...
        D.prototype.renderStripLinesOfThicknessType = function(a) {
            if (this.stripLines && 0 < this.stripLines.length && a) {
                for (var d = this, c, b = 0, e = 0, f = !1, k = !1, l = [], m = [], k = !1, b = 0; b < this.stripLines.length; b++) {
                    ...
                    h._thicknessType === a && ("pixel" === a && (h.value < this.viewportMinimum || h.value > this.viewportMaximum || s(h.value) || isNaN(this.range)) || l.push(h))
                }
                for (b = 0; b < this._stripLineLabels.length; b++)
                    ...
                    !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range))) {
                        ...
                        if ("outside" === c.stripLine.labelPlacement)
                            ...
                            a.x - c.textBlock.height > this.chart.plotArea.x1 ? s(h.startValue) ? a.x -= c.textBlock.height - c.textBlock.fontSize / 2 : a.x -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3 : (c.textBlock.angle = 90,
                            s(h.startValue) ? a.x += c.textBlock.height - c.textBlock.fontSize / 2 : a.x += c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3),
                            ...
                            c.textBlock.angle = 0,
                            c.textBlock.measureText(),
                            a.y - c.textBlock.height > this.chart.plotArea.y1 ? s(h.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize + 3 : a.y - c.textBlock.height < this.chart.plotArea.y2 ? a.y += c.textBlock.fontSize / 2 + 3 : s(h.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize + 3,
                            ...
                            c.textBlock.angle = 0,
                            c.textBlock.measureText(),
                            a.y - +c.textBlock.height > this.chart.plotArea.y1 ? s(h.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 - 3 : a.y - c.textBlock.height < this.chart.plotArea.y2 ? a.y += c.textBlock.fontSize / 2 + 3 : s(h.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3,
        ...
        D.prototype.createMask = function() {
            if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
                ...
                u ? (this.maskCanvas = sa(this.chart.width, this.chart.height),
        ...
        D.prototype.renderAxisLine = function() {
            var a = this.chart.ctx, d = u ? this.chart._preRenderCtx : a, c = Math.ceil(this.tickThickness / (this.reversed ? -2 : 2)), b = Math.ceil(this.tickThickness / (this.reversed ? 2 : -2)), e, f;
            d.save();
            if ("bottom" === this._position || "top" === this._position) {
                    ...
                    if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                        if (s(this.scaleBreaks.lastBreakIndex))
                            ...
                            for (var l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++)
                                d.moveTo(e, k),
                                d.lineTo(this.scaleBreaks._appliedBreaks[l].startPixel + c, k),
        ...
        D.prototype.calculateAxisParameters = function() {
            if (this.logarithmic)
                ...
                if ("axisX" === this.type && c) {
                    ...
                    this.intervalType = "millisecond") : b / (1 * Q.secondDuration) <= a ? (this.interval = 1,
                    this.intervalType = "second") : b / (2 * Q.secondDuration) <= a ? (this.interval = 2,
                    this.intervalType = "second") : b / (5 * Q.secondDuration) <= a ? (this.interval = 5,
                    this.intervalType = "second") : b / (10 * Q.secondDuration) <= a ? (this.interval = 10,
                    this.intervalType = "second") : b / (15 * Q.secondDuration) <= a ? (this.interval = 15,
                    this.intervalType = "second") : b / (20 * Q.secondDuration) <= a ? (this.interval = 20,
                    this.intervalType = "second") : b / (30 * Q.secondDuration) <= a ? (this.interval = 30,
                    this.intervalType = "second") : b / (1 * Q.minuteDuration) <= a ? (this.interval = 1,
                    this.intervalType = "minute") : b / (2 * Q.minuteDuration) <= a ? (this.interval = 2,
                    this.intervalType = "minute") : b / (5 * Q.minuteDuration) <= a ? (this.interval = 5,
                    this.intervalType = "minute") : b / (10 * Q.minuteDuration) <= a ? (this.interval = 10,
                    this.intervalType = "minute") : b / (15 * Q.minuteDuration) <= a ? (this.interval = 15,
                    this.intervalType = "minute") : b / (20 * Q.minuteDuration) <= a ? (this.interval = 20,
                    this.intervalType = "minute") : b / (30 * Q.minuteDuration) <= a ? (this.interval = 30,
                    this.intervalType = "minute") : b / (1 * Q.hourDuration) <= a ? (this.interval = 1,
                    this.intervalType = "hour") : b / (2 * Q.hourDuration) <= a ? (this.interval = 2,
                    this.intervalType = "hour") : b / (3 * Q.hourDuration) <= a ? (this.interval = 3,
                    this.intervalType = "hour") : b / (6 * Q.hourDuration) <= a ? (this.interval = 6,
                    this.intervalType = "hour") : b / (1 * Q.dayDuration) <= a ? (this.interval = 1,
                    this.intervalType = "day") : b / (2 * Q.dayDuration) <= a ? (this.interval = 2,
                    this.intervalType = "day") : b / (4 * Q.dayDuration) <= a ? (this.interval = 4,
                    this.intervalType = "day") : b / (1 * Q.weekDuration) <= a ? (this.interval = 1,
                    this.intervalType = "week") : b / (2 * Q.weekDuration) <= a ? (this.interval = 2,
                    this.intervalType = "week") : b / (3 * Q.weekDuration) <= a ? (this.interval = 3,
                    this.intervalType = "week") : b / (1 * Q.monthDuration) <= a ? (this.interval = 1,
                    this.intervalType = "month") : b / (2 * Q.monthDuration) <= a ? (this.interval = 2,
                    this.intervalType = "month") : b / (3 * Q.monthDuration) <= a ? (this.interval = 3,
                    this.intervalType = "month") : b / (6 * Q.monthDuration) <= a ? (this.interval = 6,
                    this.intervalType = "month") : (this.interval = b / (1 * Q.yearDuration) <= a ? 1 : b / (2 * Q.yearDuration) <= a ? 2 : b / (4 * Q.yearDuration) <= a ? 4 : Math.floor(D.getNiceNumber(b / (a - 1), !0) / Q.yearDuration),
        ...
        U.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === r % 2 ? (b.x << 0) + 0.5 : b.x << 0,
                    k = 1 === r % 2 ? (e.x << 0) + 0.5 : e.x << 0,
                    "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1,
                    l = this.chart.plotArea.y2 + r / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2,
        ...
        aa.prototype.render = function(a, d, c) {
            var b, e, f, k, l = null, m = null, h = null, n = "";
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var u = null;
                    if ("bottom" === this.parent._position || "top" === this.parent._position)
                        w = this.parent.dataSeries[0].axisX.convertPixelToValue({
                            y: d
                        });
                    else if ("left" === this.parent._position || "right" === this.parent._position)
                    ...
                    for (var v = 0; v < this.parent.dataSeries.length; v++)
                        (u = this.parent.dataSeries[v].getDataPointAtX(w, !0)) && 0 <= u.index && (u.dataSeries = this.parent.dataSeries[v],
                    ...
                    if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type)
                        for (var u = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y[0])), t = 0, w = 0; w < n.length; w++)
                            if (n[w].dataPoint.y && n[w].dataPoint.y.length)
                                for (var x = 0; x < n[w].dataPoint.y.length; x++)
                                    t = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y[x])),
                                    t < u && (u = t,
                                    v = w);
                            else
                                t = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y)),
                                t < u && (u = t,
                                v = w);
                        ...
                        for (var u = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), y = z = t = 0, w = 0; w < n.length; w++)
                            if (n[w].dataPoint.y && n[w].dataPoint.y.length)
                                ...
                                z += n[w].dataPoint.y,
                                y = n[w].dataPoint.x.getTime ? n[w].dataPoint.x.getTime() : n[w].dataPoint.x,
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[v].type || "error" === this.parent.dataSeries[v].type) {
                            ...
                            for (w = t = 0; w < x.dataPoint.y.length; w++)
                                t = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[w])),
                                t < u && (u = t,
                                b = w);
                        ...
                        if (this.parent.labels)
                            ...
                            w = 0; w < this.parent.viewportMaximum; w += n)
                                if (this.parent.labels[w])
                                    y = !0;
                                else {
                                    y = !1;
                                    break
                        ...
                        if (y) {
                            if ("axisX" === this.parent.type)
                                ...
                                u = null,
                                v = 0; v < this.parent.dataSeries.length; v++)
                                    (u = this.parent.dataSeries[v].getDataPointAtX(w, !0)) && 0 <= u.index && (h.text = this.labelFormatter ? this.labelFormatter({
                                        chart: this.chart,
                                        axis: this.parent.options,
                                        crosshair: this.options,
                                        value: x.dataPoint.x
                            ...
                            "dateTime" === this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                    ...
                    !s(this.parent.dataSeries) && 0 < this.parent.dataSeries.length && (w = this.parent.dataSeries[0].axisX.convertPixelToValue({
                        x: a
                    }));
                    for (v = 0; v < this.parent.dataSeries.length; v++)
                        (u = this.parent.dataSeries[v].getDataPointAtX(w, !0)) && 0 <= u.index && (u.dataSeries = this.parent.dataSeries[v],
                    ...
                    if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" === n[0].dataSeries.type || "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type || "boxAndWhisker" === n[0].dataSeries.type)
                        ...
                        w = t = 0; w < n.length; w++)
                            if (n[w].dataPoint.y && n[w].dataPoint.y.length)
                                for (x = 0; x < n[w].dataPoint.y.length; x++)
                                    t = Math.abs(d - this.parent.convertValueToPixel(n[w].dataPoint.y[x])),
                                    t < u && (u = t,
                                    v = w);
                            else
                                t = Math.abs(d - this.parent.convertValueToPixel(n[w].dataPoint.y)),
                                t < u && (u = t,
                                v = w);
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[v].type || "rangeArea" === this.parent.dataSeries[v].type || "error" === this.parent.dataSeries[v].type || "rangeSplineArea" === this.parent.dataSeries[v].type || "candlestick" === this.parent.dataSeries[v].type || "ohlc" === this.parent.dataSeries[v].type || "boxAndWhisker" === this.parent.dataSeries[v].type) {
                        ...
                        for (w = t = 0; w < x.dataPoint.y.length; w++)
                            t = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[w])),
                            t < u && (u = t,
                            b = w);
                        ...
                        "waterfall" === this.parent.dataSeries[v].type ? (m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0,
                        h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum
                        }) : s(this.options.label) ? ea(c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo) : this.label,
                        this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (m = 1 === q.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0,
                        h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    ...
                    b >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && e <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && (0 < r && (q.moveTo(b, f),
                    q.lineTo(e, k),
                    q.stroke(),
                    this._hidden = !1),
                    q.restore(),
                ...
                if ("left" === this.parent._position || "right" === this.parent._position)
                    ...
                    k >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && (0 < r && (q.moveTo(b, f),
                    q.lineTo(e, k),
                    q.stroke(),
                    this._hidden = !1),
                    q.restore(),
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    ...
                    if (y) {
                        ...
                        "dateTime" === this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: c ? c : this.parent.convertPixelToValue(a)
                        }) : s(this.options.label) ? za(c ? c : this.parent.convertPixelToValue(a), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var m = 0; m < this.chart.axisX.length; m++) {
                                for (var k = this.chart.axisX[m].convertPixelToValue({
                                    y: d
                                }), h = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)
                                    (h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[b],
                        ...
                        if (this.chart.axisX2)
                            for (m = 0; m < this.chart.axisX2.length; m++) {
                                ...
                                for (b = 0; b < this.chart.axisX2[m].dataSeries.length; b++)
                                    (h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[m].dataSeries[b],
                                    null !== h.dataPoint.y && l.push(h));
                                h = null
                            }
                    } else {
                        ...
                        if (this.chart.axisX)
                            for (m = 0; m < this.chart.axisX.length; m++)
                                ...
                                h = null,
                                b = 0; b < this.chart.axisX[m].dataSeries.length; b++)
                                    (h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[m].dataSeries[b],
                                    null !== h.dataPoint.y && l.push(h));
                        if (this.chart.axisX2)
                            for (m = 0; m < this.chart.axisX2.length; m++)
                                ...
                                h = null,
                                b = 0; b < this.chart.axisX2[m].dataSeries.length; b++)
                                    (h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[m].dataSeries[b],
                                    null !== h.dataPoint.y && l.push(h))
                    }
                    if (0 === l.length)
                    ...
                    if (h = this.chart.getDataPointAtXY(a, d, c))
                        ...
                        if (h = Xa(a, d, this.chart._eventManager.ghostCtx),
                        ...
                        if (!s(h) && !s(h.dataPoint) && !s(h.dataPoint.y))
                            if (h.dataSeries.axisY)
                                if (0 < h.dataPoint.y.length) {
                                    ...
                                    "column" === e.type || "bar" === e.type ? 0 > h.dataPoint.y ? 0 > h.dataSeries.axisY.viewportMinimum && h.dataSeries.axisY.viewportMaximum >= h.dataPoint.y && f.push(h) : h.dataSeries.axisY.viewportMinimum <= h.dataPoint.y && 0 <= h.dataSeries.axisY.viewportMaximum && f.push(h) : "bubble" === e.type ? (c = this.chart._eventManager.objectMap[e.dataPointIds[h.index]].size / 2,
                                    h.dataPoint.y >= h.dataSeries.axisY.viewportMinimum - c && h.dataPoint.y <= h.dataSeries.axisY.viewportMaximum + c && f.push(h)) : "waterfall" === e.type ? (c = 0,
                                    ...
                                    2 > c && -2 < c && f.push(h)) : (0 <= h.dataSeries.type.indexOf("100") || "stackedColumn" === e.type || "stackedBar" === e.type || h.dataPoint.y >= h.dataSeries.axisY.viewportMinimum && h.dataPoint.y <= h.dataSeries.axisY.viewportMaximum) && f.push(h);
                            else
                                f.push(h)
                    }
                }
        ...
        $.prototype.highlightObjects = function(a) {
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    ...
                    d.globalAlpha = 0.3,
                    X.drawMarkers([f]),
                    d.globalAlpha = 1) : "column" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "bar" === b.type || "rangeBar" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "rangeColumn" === b.type || "waterfall" === b.type ? ca(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? Y(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? pa(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1,
                    ...
                    d.stroke()),
                    d.beginPath(),
                    ca(d, e.x1 - e.borderThickness / 2, Math.max(e.y2 + e.borderThickness / 2, e.y3 + e.borderThickness / 2), e.x2 + e.borderThickness / 2, Math.min(e.y2 - e.borderThickness / 2, e.y3 - e.borderThickness / 2), "transparent", e.borderThickness, e.color, !1, !1, !1, !1),
                    d.globalAlpha = 1,
        ...
        $.prototype.getToolTipInnerHTML = function(a) {
            ...
            if (k && (this.content && "function" === typeof this.content || this.contentFormatter))
                ...
                for (var m = null, h = "", l = 0; l < a.length; l++)
                    ...
                    e = a[l].index,
                    f = "",
                    0 === l && (k && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? h += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ? this.chart.axisX[0].labels[b.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length && (h += "undefined" !== typeof this.chart.axisX2[0].labels[b.x] ? this.chart.axisX2[0].labels[b.x] : "{x}"),
                    h += "</br>",
                    ...
                    m = c.axisXIndex) : "bubble" === c.type ? (this.chart.axisX && 1 < this.chart.axisX.length && (f += m != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""),
                    ...
                    f += b.toolTipContent ? b.toolTipContent : c.toolTipContent ? c.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.options.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low:&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}") : "boxAndWhisker" === c.type && (this.chart.axisX && 1 < this.chart.axisX.length && (f += m != c.axisXIndex ? c.axisX.title ? c.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""),
          ...
          , X = {
            drawMarker: function(a, d, c, b, e, f, k, l) {
                if (c) {
                    ...
                    f && c.fill(),
                    l && (k ? c.stroke() : (m = c.globalAlpha,
                    c.globalAlpha = 0.15,
                    c.strokeStyle = "black",
                    c.stroke(),
                    c.globalAlpha = m))) : "square" === b ? (c.beginPath(),
                    ...
                    c.strokeStyle = "black",
                    c.stroke(),
                    c.globalAlpha = m))) : "triangle" === b ? (c.beginPath(),
